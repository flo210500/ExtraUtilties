   ...
   public static void executeProcedure(Map<String, Object> dependencies) {
      if (dependencies.get("world") == null) {
         if (!dependencies.containsKey("world")) {
            ExtrautilitiesrebirthMod.LOGGER.warn("Failed to load dependency world for procedure CulinaryGeneratorUpdateTick!");
         }

      } else if (dependencies.get("x") == null) {
         if (!dependencies.containsKey("x")) {
            ExtrautilitiesrebirthMod.LOGGER.warn("Failed to load dependency x for procedure CulinaryGeneratorUpdateTick!");
         }

      } else if (dependencies.get("y") == null) {
         if (!dependencies.containsKey("y")) {
            ExtrautilitiesrebirthMod.LOGGER.warn("Failed to load dependency y for procedure CulinaryGeneratorUpdateTick!");
         }

      } else if (dependencies.get("z") == null) {
         if (!dependencies.containsKey("z")) {
            ExtrautilitiesrebirthMod.LOGGER.warn("Failed to load dependency z for procedure CulinaryGeneratorUpdateTick!");
         }
         ...
         if (!((<undefinedtype>)(new Object() {
            ...
            })).getItemStack(new BlockPos(x, y, z), 0).func_77973_b().func_219971_r() ? ((<undefinedtype>)(new Object() {
               public ItemStack getItemStack(BlockPos pos, int sltid) {
                  AtomicReference<ItemStack> _retval = new AtomicReference(ItemStack.field_190927_a);
                  TileEntity _ent = world.func_175625_s(pos);
                  if (_ent != null) {
            ...
            })).getItemStack(new BlockPos(x, y, z), 0).func_77973_b().func_219967_s().func_221466_a() : 0) > 0;
            multiplier = 1.0D;
            ...
            burntime = 600.0D;
            energytick = (double)((((<undefinedtype>)(new Object() {
               public ItemStack getItemStack(BlockPos pos, int sltid) {
                  AtomicReference<ItemStack> _retval = new AtomicReference(ItemStack.field_190927_a);
                  TileEntity _ent = world.func_175625_s(pos);
                  if (_ent != null) {
            ...
            })).getItemStack(new BlockPos(x, y, z), 0).func_77973_b().func_219967_s().func_221466_a() : 0) * 6) * multiplier;
            if (((<undefinedtype>)(new Object() {
