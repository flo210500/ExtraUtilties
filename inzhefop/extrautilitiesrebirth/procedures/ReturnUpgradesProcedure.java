   ...
   public static double executeProcedure(Map<String, Object> dependencies) {
      if (dependencies.get("world") == null) {
         if (!dependencies.containsKey("world")) {
            ExtrautilitiesrebirthMod.LOGGER.warn("Failed to load dependency world for procedure ReturnUpgrades!");
         }

         return 0.0D;
      } else if (dependencies.get("x") == null) {
         if (!dependencies.containsKey("x")) {
            ExtrautilitiesrebirthMod.LOGGER.warn("Failed to load dependency x for procedure ReturnUpgrades!");
         }

         return 0.0D;
      } else if (dependencies.get("y") == null) {
         if (!dependencies.containsKey("y")) {
            ExtrautilitiesrebirthMod.LOGGER.warn("Failed to load dependency y for procedure ReturnUpgrades!");
         }

         return 0.0D;
      } else if (dependencies.get("z") == null) {
         if (!dependencies.containsKey("z")) {
            ExtrautilitiesrebirthMod.LOGGER.warn("Failed to load dependency z for procedure ReturnUpgrades!");
         }
         ...
         return SpeedUpgradeItem.block == ((<undefinedtype>)(new Object() {
         ...
         })).getItemStack(new BlockPos(x, y, z), 2).func_77973_b() ? (double)((<undefinedtype>)(new Object() {
         ...
         })).getAmount(world, new BlockPos(x, y, z), 2) : 0.0D;
      }
   }
}
