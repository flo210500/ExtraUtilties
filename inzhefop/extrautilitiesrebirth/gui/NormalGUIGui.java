...
public class NormalGUIGui extends ExtrautilitiesrebirthModElements.ModElement {
   public static HashMap guistate = new HashMap();
   private static ContainerType<NormalGUIGui.GuiContainerMod> containerType = null;

   public NormalGUIGui(ExtrautilitiesrebirthModElements instance) {
      super(instance, 177);
      this.elements.addNetworkMessage(NormalGUIGui.ButtonPressedMessage.class, NormalGUIGui.ButtonPressedMessage::buffer, NormalGUIGui.ButtonPressedMessage::new, NormalGUIGui.ButtonPressedMessage::handler);
      this.elements.addNetworkMessage(NormalGUIGui.GUISlotChangedMessage.class, NormalGUIGui.GUISlotChangedMessage::buffer, NormalGUIGui.GUISlotChangedMessage::new, NormalGUIGui.GUISlotChangedMessage::handler);
      containerType = new ContainerType(new NormalGUIGui.GuiContainerModFactory());
      FMLJavaModLoadingContext.get().getModEventBus().register(new NormalGUIGui.ContainerRegisterHandler());
   }

   @OnlyIn(Dist.CLIENT)
   public void initElements() {
      DeferredWorkQueue.runLater(() -> {
         ScreenManager.func_216911_a(containerType, NormalGUIGuiWindow::new);
      });
   }
   ...
   public static class GUISlotChangedMessage {
      ...
      public static void buffer(NormalGUIGui.GUISlotChangedMessage message, PacketBuffer buffer) {
      ...
      public static void handler(NormalGUIGui.GUISlotChangedMessage message, Supplier<Context> contextSupplier) {
         ...
         context.enqueueWork(() -> {
            ...
            int y = message.y;
            int z = message.z;
            NormalGUIGui.handleSlotAction(entity, slotID, changeType, meta, x, y, z);
         });
   ...
   public static class ButtonPressedMessage {
      ...
      public static void buffer(NormalGUIGui.ButtonPressedMessage message, PacketBuffer buffer) {
      ...
      public static void handler(NormalGUIGui.ButtonPressedMessage message, Supplier<Context> contextSupplier) {
         Context context = (Context)contextSupplier.get();
         context.enqueueWork(() -> {
            PlayerEntity entity = context.getSender();
            ...
            int y = message.y;
            int z = message.z;
            NormalGUIGui.handleButtonAction(entity, buttonID, x, y, z);
         });
         context.setPacketHandled(true);
      }
   }
   ...
   public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
      ...
      public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
         super(NormalGUIGui.containerType, id);
         ...
         this.customSlots.put(0, this.func_75146_a(new SlotItemHandler(this.internal, 0, 61, 36) {
         }));
         this.customSlots.put(1, this.func_75146_a(new SlotItemHandler(this.internal, 1, 7, 18) {
         }));
      ...
      private void slotChanged(int slotid, int ctype, int meta) {
         if (this.world != null && this.world.func_201670_d()) {
            ExtrautilitiesrebirthMod.PACKET_HANDLER.sendToServer(new NormalGUIGui.GUISlotChangedMessage(slotid, this.x, this.y, this.z, ctype, meta));
            NormalGUIGui.handleSlotAction(this.entity, slotid, ctype, meta, this.x, this.y, this.z);
         }
   ...
   public static class GuiContainerModFactory implements IContainerFactory {
      public NormalGUIGui.GuiContainerMod create(int id, PlayerInventory inv, PacketBuffer extraData) {
         return new NormalGUIGui.GuiContainerMod(id, inv, extraData);
      }
   }
   ...
   private static class ContainerRegisterHandler {
      ...
      public void registerContainer(Register<ContainerType<?>> event) {
         event.getRegistry().register(NormalGUIGui.containerType.setRegistryName("normal_gui"));
      }
