...
@OnlyIn(Dist.CLIENT)
public class MechanicalMinerGUIGuiWindow extends ContainerScreen<MechanicalMinerGUIGui.GuiContainerMod> {
   private World world;
   private int x;
   private int y;
   private int z;
   ...
   public MechanicalMinerGUIGuiWindow(MechanicalMinerGUIGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
   ...
   protected void func_230450_a_(MatrixStack ms, float partialTicks, int gx, int gy) {
      ...
      func_238463_a_(ms, this.field_147003_i + 7, this.field_147009_r + 20, 0.0F, 0.0F, 16, 16, 16, 16);
   ...
   protected void func_230451_b_(MatrixStack ms, int mouseX, int mouseY) {
      this.field_230712_o_.func_238421_b_(ms, "Mechanical Miner", 7.0F, 6.0F, -12829636);
   }
   ...
   static {
      guistate = MechanicalMinerGUIGui.guistate;
      texture = new ResourceLocation("extrautilitiesrebirth:textures/screens/mechanical_miner_gui.png");
   }
}
