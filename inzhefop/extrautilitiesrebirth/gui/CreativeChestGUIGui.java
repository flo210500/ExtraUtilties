...
public class CreativeChestGUIGui extends ExtrautilitiesrebirthModElements.ModElement {
   public static HashMap guistate = new HashMap();
   private static ContainerType<CreativeChestGUIGui.GuiContainerMod> containerType = null;

   public CreativeChestGUIGui(ExtrautilitiesrebirthModElements instance) {
      super(instance, 155);
      this.elements.addNetworkMessage(CreativeChestGUIGui.ButtonPressedMessage.class, CreativeChestGUIGui.ButtonPressedMessage::buffer, CreativeChestGUIGui.ButtonPressedMessage::new, CreativeChestGUIGui.ButtonPressedMessage::handler);
      this.elements.addNetworkMessage(CreativeChestGUIGui.GUISlotChangedMessage.class, CreativeChestGUIGui.GUISlotChangedMessage::buffer, CreativeChestGUIGui.GUISlotChangedMessage::new, CreativeChestGUIGui.GUISlotChangedMessage::handler);
      containerType = new ContainerType(new CreativeChestGUIGui.GuiContainerModFactory());
      FMLJavaModLoadingContext.get().getModEventBus().register(new CreativeChestGUIGui.ContainerRegisterHandler());
   }

   @OnlyIn(Dist.CLIENT)
   public void initElements() {
      DeferredWorkQueue.runLater(() -> {
         ScreenManager.func_216911_a(containerType, CreativeChestGUIGuiWindow::new);
      });
   }
   ...
   public static class GUISlotChangedMessage {
      ...
      public static void buffer(CreativeChestGUIGui.GUISlotChangedMessage message, PacketBuffer buffer) {
      ...
      public static void handler(CreativeChestGUIGui.GUISlotChangedMessage message, Supplier<Context> contextSupplier) {
         ...
         context.enqueueWork(() -> {
            ...
            int y = message.y;
            int z = message.z;
            CreativeChestGUIGui.handleSlotAction(entity, slotID, changeType, meta, x, y, z);
         });
   ...
   public static class ButtonPressedMessage {
      ...
      public static void buffer(CreativeChestGUIGui.ButtonPressedMessage message, PacketBuffer buffer) {
      ...
      public static void handler(CreativeChestGUIGui.ButtonPressedMessage message, Supplier<Context> contextSupplier) {
         Context context = (Context)contextSupplier.get();
         context.enqueueWork(() -> {
            PlayerEntity entity = context.getSender();
            ...
            int y = message.y;
            int z = message.z;
            CreativeChestGUIGui.handleButtonAction(entity, buttonID, x, y, z);
         });
         context.setPacketHandled(true);
      }
   }
   ...
   public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
      ...
      public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
         super(CreativeChestGUIGui.containerType, id);
         ...
         this.customSlots.put(0, this.func_75146_a(new SlotItemHandler(this.internal, 0, 52, 35) {
         }));
         this.customSlots.put(1, this.func_75146_a(new SlotItemHandler(this.internal, 1, 106, 35) {
      ...
      public ItemStack func_82846_b(PlayerEntity playerIn, int index) {
         ...
         if (slot != null && slot.func_75216_d()) {
            ...
            if (index < 2) {
               ...
               if (index < 29) {
                  if (!this.func_75135_a(itemstack1, 29, this.field_75151_b.size(), true)) {
                     return ItemStack.field_190927_a;
                  }
               } else if (!this.func_75135_a(itemstack1, 2, 29, false)) {
                  return ItemStack.field_190927_a;
               }
      ...
      private void slotChanged(int slotid, int ctype, int meta) {
         if (this.world != null && this.world.func_201670_d()) {
            ExtrautilitiesrebirthMod.PACKET_HANDLER.sendToServer(new CreativeChestGUIGui.GUISlotChangedMessage(slotid, this.x, this.y, this.z, ctype, meta));
            CreativeChestGUIGui.handleSlotAction(this.entity, slotid, ctype, meta, this.x, this.y, this.z);
         }
   ...
   public static class GuiContainerModFactory implements IContainerFactory {
      public CreativeChestGUIGui.GuiContainerMod create(int id, PlayerInventory inv, PacketBuffer extraData) {
         return new CreativeChestGUIGui.GuiContainerMod(id, inv, extraData);
      }
   }
   ...
   private static class ContainerRegisterHandler {
      ...
      public void registerContainer(Register<ContainerType<?>> event) {
         event.getRegistry().register(CreativeChestGUIGui.containerType.setRegistryName("creative_chest_gui"));
      }
