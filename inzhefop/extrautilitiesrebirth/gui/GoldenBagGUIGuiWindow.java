...
@OnlyIn(Dist.CLIENT)
public class GoldenBagGUIGuiWindow extends ContainerScreen<GoldenBagGUIGui.GuiContainerMod> {
   private World world;
   private int x;
   private int y;
   private int z;
   ...
   public GoldenBagGUIGuiWindow(GoldenBagGUIGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
   ...
   protected void func_230451_b_(MatrixStack ms, int mouseX, int mouseY) {
      this.field_230712_o_.func_238421_b_(ms, "Golden Bag of Holding", 7.0F, 6.0F, -12829636);
   }
   ...
   static {
      guistate = GoldenBagGUIGui.guistate;
      texture = new ResourceLocation("extrautilitiesrebirth:textures/screens/golden_bag_gui.png");
   }
}
