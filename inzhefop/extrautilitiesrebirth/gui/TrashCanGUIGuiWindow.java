...
@OnlyIn(Dist.CLIENT)
public class TrashCanGUIGuiWindow extends ContainerScreen<TrashCanGUIGui.GuiContainerMod> {
   private World world;
   private int x;
   private int y;
   private int z;
   ...
   public TrashCanGUIGuiWindow(TrashCanGUIGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
   ...
   protected void func_230451_b_(MatrixStack ms, int mouseX, int mouseY) {
      ...
      this.field_230712_o_.func_238421_b_(ms, "Trash-Can", 7.0F, 5.0F, -12829636);
   }
   ...
   static {
      guistate = TrashCanGUIGui.guistate;
      texture = new ResourceLocation("extrautilitiesrebirth:textures/screens/trash_can_gui.png");
   }
}
