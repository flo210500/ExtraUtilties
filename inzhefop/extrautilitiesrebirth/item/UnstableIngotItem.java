...
public class UnstableIngotItem extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:unstable_ingot")
   public static final Item block = null;

   public UnstableIngotItem(ExtrautilitiesrebirthModElements instance) {
      super(instance, 138);
   }

   public void initElements() {
      this.elements.items.add(() -> {
         return new UnstableIngotItem.ItemCustom();
      });
   }
   ...
   public static class ItemCustom extends Item {
      public ItemCustom() {
         ...
         this.setRegistryName("unstable_ingot");
      }
