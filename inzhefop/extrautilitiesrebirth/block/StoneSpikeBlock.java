...
public class StoneSpikeBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:stone_spike")
   public static final Block block = null;

   public StoneSpikeBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 48);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new StoneSpikeBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         super(net.minecraft.block.AbstractBlock.Properties.func_200945_a(Material.field_151576_e).func_200947_a(SoundType.field_185851_d).func_200948_a(8.0F, 30.0F).func_235838_a_((s) -> {
            return 0;
         }).harvestLevel(1).harvestTool(ToolType.PICKAXE).func_226896_b_().func_235828_a_((bs, br, bp) -> {
            return false;
         }));
         this.setRegistryName("stone_spike");
      }
