...
public class DarkGlassBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:dark_glass")
   public static final Block block = null;

   public DarkGlassBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 54);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new DarkGlassBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("dark_glass");
      }
