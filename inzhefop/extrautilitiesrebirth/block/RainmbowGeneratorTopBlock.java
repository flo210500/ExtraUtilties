...
public class RainmbowGeneratorTopBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:rainmbow_generator_top")
   public static final Block block = null;

   public RainmbowGeneratorTopBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 86);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new RainmbowGeneratorTopBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends SlabBlock {
      public CustomBlock() {
         ...
         this.setRegistryName("rainmbow_generator_top");
      }
