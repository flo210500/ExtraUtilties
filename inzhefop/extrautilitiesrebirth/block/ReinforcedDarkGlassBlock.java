...
public class ReinforcedDarkGlassBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:reinforced_dark_glass")
   public static final Block block = null;

   public ReinforcedDarkGlassBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 65);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new ReinforcedDarkGlassBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         super(net.minecraft.block.AbstractBlock.Properties.func_200945_a(Material.field_151592_s).func_200947_a(SoundType.field_185853_f).func_200948_a(0.1F, 8000.0F).func_235838_a_((s) -> {
            return 0;
         }).func_226896_b_().func_235828_a_((bs, br, bp) -> {
            return false;
         }));
         this.setRegistryName("reinforced_dark_glass");
      }
