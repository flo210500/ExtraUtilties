...
public class TripleCompressedCobblestoneBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:triple_compressed_cobblestone")
   public static final Block block = null;

   public TripleCompressedCobblestoneBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 20);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new TripleCompressedCobblestoneBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("triple_compressed_cobblestone");
      }
      ...
      public void func_190948_a(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
         ...
         list.add(new StringTextComponent("§7729 Blocks"));
      }
