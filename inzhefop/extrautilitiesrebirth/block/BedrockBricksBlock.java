...
public class BedrockBricksBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:bedrock_bricks")
   public static final Block block = null;

   public BedrockBricksBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 3);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new BedrockBricksBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      ...
      public CustomBlock() {
         ...
         this.setRegistryName("bedrock_bricks");
      }
