...
public class DiamondSpikeBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:diamond_spike")
   public static final Block block = null;

   public DiamondSpikeBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 44);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new DiamondSpikeBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         super(net.minecraft.block.AbstractBlock.Properties.func_200945_a(Material.field_151573_f).func_200947_a(SoundType.field_185852_e).func_200948_a(10.0F, 1000.0F).func_235838_a_((s) -> {
            return 0;
         }).harvestLevel(2).harvestTool(ToolType.PICKAXE).func_226896_b_().func_235828_a_((bs, br, bp) -> {
            return false;
         }));
         this.setRegistryName("diamond_spike");
      }
