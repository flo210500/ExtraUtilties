...
public class EnderLillyStage1Block extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:ender_lilly_stage_1")
   public static final Block block = null;

   public EnderLillyStage1Block(ExtrautilitiesrebirthModElements instance) {
      super(instance, 49);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new EnderLillyStage1Block.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("ender_lilly_stage_1");
      }
