...
public class EnderQuarrySilkTouchUpgrade3Block extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:ender_quarry_silk_touch_upgrade_3")
   public static final Block block = null;

   public EnderQuarrySilkTouchUpgrade3Block(ExtrautilitiesrebirthModElements instance) {
      super(instance, 107);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new EnderQuarrySilkTouchUpgrade3Block.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("ender_quarry_silk_touch_upgrade_3");
      }
      ...
      public void func_190948_a(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
         ...
         list.add(new StringTextComponent("§7Enchanter: Speed II Upgrade + Tool [Enchantment: efficiency >= 5]"));
      }
