...
public class DarkEtherealGlassBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:dark_ethereal_glass")
   public static final Block block = null;

   public DarkEtherealGlassBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 53);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new DarkEtherealGlassBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("dark_ethereal_glass");
      }
