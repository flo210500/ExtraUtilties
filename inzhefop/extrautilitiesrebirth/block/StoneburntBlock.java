...
public class StoneburntBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:stoneburnt")
   public static final Block block = null;

   public StoneburntBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 16);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new StoneburntBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         super(net.minecraft.block.AbstractBlock.Properties.func_200945_a(Material.field_151576_e).func_200947_a(SoundType.field_185851_d).func_200948_a(5.0F, 49.0F).func_235838_a_((s) -> {
            return 0;
         }).harvestLevel(1).harvestTool(ToolType.PICKAXE));
         this.setRegistryName("stoneburnt");
      }
      ...
      public void func_190948_a(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
         ...
         list.add(new StringTextComponent("§7Resonator: Polished Stone [8000 FE]"));
      }
