...
public class SwirlingGlassBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:swirling_glass")
   public static final Block block = null;

   public SwirlingGlassBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 67);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new SwirlingGlassBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("swirling_glass");
      }
