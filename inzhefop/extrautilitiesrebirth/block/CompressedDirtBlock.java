...
public class CompressedDirtBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:compressed_dirt")
   public static final Block block = null;

   public CompressedDirtBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 26);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new CompressedDirtBlock.CustomBlock();
      });
