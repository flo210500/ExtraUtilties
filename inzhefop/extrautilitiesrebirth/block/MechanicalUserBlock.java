...
import inzhefop.extrautilitiesrebirth.gui.MechanicalUserGUIGui;
...
public class MechanicalUserBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:mechanical_user")
   public static final Block block = null;
   @ObjectHolder("extrautilitiesrebirth:mechanical_user")
   public static final TileEntityType<MechanicalUserBlock.CustomTileEntity> tileEntityType = null;

   public MechanicalUserBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 98);
      FMLJavaModLoadingContext.get().getModEventBus().register(new MechanicalUserBlock.TileEntityRegisterHandler());
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new MechanicalUserBlock.CustomBlock();
      });
   ...
   public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
      ...
      protected CustomTileEntity() {
         super(MechanicalUserBlock.tileEntityType);
         ...
         this.energyStorage = new EnergyStorage(25000, 25000, 25000, 0) {
      ...
      public ITextComponent func_213907_g() {
         return new StringTextComponent("mechanical_user");
      }
      ...
      public Container func_213906_a(int id, PlayerInventory player) {
         return new MechanicalUserGUIGui.GuiContainerMod(id, player, (new PacketBuffer(Unpooled.buffer())).func_179255_a(this.func_174877_v()));
      }

      public ITextComponent func_145748_c_() {
         return new StringTextComponent("Mechanical User");
      }
   ...
   public static class CustomBlock extends Block {
      ...
      public CustomBlock() {
         super(net.minecraft.block.AbstractBlock.Properties.func_200945_a(Material.field_151576_e).func_200947_a(SoundType.field_185851_d).func_200948_a(3.0F, 50.0F).func_235838_a_((s) -> {
            return 0;
         }).harvestLevel(2).harvestTool(ToolType.PICKAXE));
         this.func_180632_j((BlockState)((BlockState)this.field_176227_L.func_177621_b()).func_206870_a(FACING, Direction.NORTH));
         this.setRegistryName("mechanical_user");
      }
      ...
      public void func_220082_b(BlockState blockstate, World world, BlockPos pos, BlockState oldState, boolean moving) {
         ...
         MechanicalUserBlockAddedProcedure.executeProcedure((Map)Stream.of(new SimpleEntry("world", world), new SimpleEntry("x", x), new SimpleEntry("y", y), new SimpleEntry("z", z)).collect(HashMap::new, (_m, _e) -> {
      ...
      public void func_225534_a_(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
         ...
         int y = pos.func_177956_o();
         int z = pos.func_177952_p();
         MechanicalUserUpdateTickProcedure.executeProcedure((Map)Stream.of(new SimpleEntry("world", world), new SimpleEntry("x", x), new SimpleEntry("y", y), new SimpleEntry("z", z)).collect(HashMap::new, (_m, _e) -> {
            _m.put(_e.getKey(), _e.getValue());
         }, Map::putAll));
         world.func_205220_G_().func_205360_a(pos, this, 1);
      }
         ...
         if (entity instanceof ServerPlayerEntity) {
            NetworkHooks.openGui((ServerPlayerEntity)entity, new INamedContainerProvider() {
               ...
               public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
                  return new MechanicalUserGUIGui.GuiContainerMod(id, inventory, (new PacketBuffer(Unpooled.buffer())).func_179255_a(new BlockPos(x, y, z)));
               }
            }, new BlockPos(x, y, z));
         }
      ...
      public TileEntity createTileEntity(BlockState state, IBlockReader world) {
         return new MechanicalUserBlock.CustomTileEntity();
      }
      ...
      public void func_196243_a(BlockState state, World world, BlockPos pos, BlockState newState, boolean isMoving) {
         if (state.func_177230_c() != newState.func_177230_c()) {
            TileEntity tileentity = world.func_175625_s(pos);
            if (tileentity instanceof MechanicalUserBlock.CustomTileEntity) {
               InventoryHelper.func_180175_a(world, pos, (MechanicalUserBlock.CustomTileEntity)tileentity);
      ...
      public int func_180641_l(BlockState blockState, World world, BlockPos pos) {
         TileEntity tileentity = world.func_175625_s(pos);
         return tileentity instanceof MechanicalUserBlock.CustomTileEntity ? Container.func_94526_b((MechanicalUserBlock.CustomTileEntity)tileentity) : 0;
      }
   ...
   private static class TileEntityRegisterHandler {
      ...
      public void registerTileEntity(Register<TileEntityType<?>> event) {
         event.getRegistry().register(net.minecraft.tileentity.TileEntityType.Builder.func_223042_a(MechanicalUserBlock.CustomTileEntity::new, new Block[]{MechanicalUserBlock.block}).func_206865_a((Type)null).setRegistryName("mechanical_user"));
      }
