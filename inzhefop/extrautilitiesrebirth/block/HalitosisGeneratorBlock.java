...
public class HalitosisGeneratorBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:halitosis_generator")
   public static final Block block = null;
   @ObjectHolder("extrautilitiesrebirth:halitosis_generator")
   public static final TileEntityType<HalitosisGeneratorBlock.CustomTileEntity> tileEntityType = null;

   public HalitosisGeneratorBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 75);
      FMLJavaModLoadingContext.get().getModEventBus().register(new HalitosisGeneratorBlock.TileEntityRegisterHandler());
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new HalitosisGeneratorBlock.CustomBlock();
      });
   ...
   public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
      ...
      protected CustomTileEntity() {
         super(HalitosisGeneratorBlock.tileEntityType);
      ...
      public ITextComponent func_213907_g() {
         return new StringTextComponent("halitosis_generator");
      }
      ...
      public ITextComponent func_145748_c_() {
         return new StringTextComponent("Halitosis Generator");
      }
   ...
   public static class CustomBlock extends Block {
      ...
      public CustomBlock() {
         ...
         this.setRegistryName("halitosis_generator");
      }
      ...
      public void func_225534_a_(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
         ...
         int y = pos.func_177956_o();
         int z = pos.func_177952_p();
         HalitosisGenratorUpdateTickProcedure.executeProcedure((Map)Stream.of(new SimpleEntry("world", world), new SimpleEntry("x", x), new SimpleEntry("y", y), new SimpleEntry("z", z)).collect(HashMap::new, (_m, _e) -> {
            _m.put(_e.getKey(), _e.getValue());
         }, Map::putAll));
         world.func_205220_G_().func_205360_a(pos, this, 1);
      }
      ...
      public TileEntity createTileEntity(BlockState state, IBlockReader world) {
         return new HalitosisGeneratorBlock.CustomTileEntity();
      }
      ...
      public void func_196243_a(BlockState state, World world, BlockPos pos, BlockState newState, boolean isMoving) {
         if (state.func_177230_c() != newState.func_177230_c()) {
            TileEntity tileentity = world.func_175625_s(pos);
            if (tileentity instanceof HalitosisGeneratorBlock.CustomTileEntity) {
               InventoryHelper.func_180175_a(world, pos, (HalitosisGeneratorBlock.CustomTileEntity)tileentity);
      ...
      public int func_180641_l(BlockState blockState, World world, BlockPos pos) {
         TileEntity tileentity = world.func_175625_s(pos);
         return tileentity instanceof HalitosisGeneratorBlock.CustomTileEntity ? Container.func_94526_b((HalitosisGeneratorBlock.CustomTileEntity)tileentity) : 0;
      }
   ...
   private static class TileEntityRegisterHandler {
      ...
      public void registerTileEntity(Register<TileEntityType<?>> event) {
         event.getRegistry().register(net.minecraft.tileentity.TileEntityType.Builder.func_223042_a(HalitosisGeneratorBlock.CustomTileEntity::new, new Block[]{HalitosisGeneratorBlock.block}).func_206865_a((Type)null).setRegistryName("halitosis_generator"));
      }
