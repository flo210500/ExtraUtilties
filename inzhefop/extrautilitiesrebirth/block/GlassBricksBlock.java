...
public class GlassBricksBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:glass_bricks")
   public static final Block block = null;

   public GlassBricksBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 58);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new GlassBricksBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("glass_bricks");
      }
