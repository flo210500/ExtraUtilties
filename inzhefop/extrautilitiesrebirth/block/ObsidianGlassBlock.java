...
public class ObsidianGlassBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:obsidian_glass")
   public static final Block block = null;

   public ObsidianGlassBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 64);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new ObsidianGlassBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("obsidian_glass");
      }
