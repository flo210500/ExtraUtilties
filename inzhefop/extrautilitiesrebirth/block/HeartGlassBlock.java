...
public class HeartGlassBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:heart_glass")
   public static final Block block = null;

   public HeartGlassBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 61);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new HeartGlassBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("heart_glass");
      }
