...
public class RedstoneClockOffBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:redstone_clock_off")
   public static final Block block = null;
   @ObjectHolder("extrautilitiesrebirth:redstone_clock_off")
   public static final TileEntityType<RedstoneClockOffBlock.CustomTileEntity> tileEntityType = null;

   public RedstoneClockOffBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 205);
      FMLJavaModLoadingContext.get().getModEventBus().register(new RedstoneClockOffBlock.TileEntityRegisterHandler());
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new RedstoneClockOffBlock.CustomBlock();
      });
   ...
   public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
      ...
      protected CustomTileEntity() {
         super(RedstoneClockOffBlock.tileEntityType);
      ...
      public ITextComponent func_213907_g() {
         return new StringTextComponent("redstone_clock_off");
      }
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("redstone_clock_off");
      }
      ...
      public TileEntity createTileEntity(BlockState state, IBlockReader world) {
         return new RedstoneClockOffBlock.CustomTileEntity();
      }
      ...
      public void func_196243_a(BlockState state, World world, BlockPos pos, BlockState newState, boolean isMoving) {
         if (state.func_177230_c() != newState.func_177230_c()) {
            TileEntity tileentity = world.func_175625_s(pos);
            if (tileentity instanceof RedstoneClockOffBlock.CustomTileEntity) {
               InventoryHelper.func_180175_a(world, pos, (RedstoneClockOffBlock.CustomTileEntity)tileentity);
      ...
      public int func_180641_l(BlockState blockState, World world, BlockPos pos) {
         TileEntity tileentity = world.func_175625_s(pos);
         return tileentity instanceof RedstoneClockOffBlock.CustomTileEntity ? Container.func_94526_b((RedstoneClockOffBlock.CustomTileEntity)tileentity) : 0;
      }
   }
   ...
   private static class TileEntityRegisterHandler {
      ...
      public void registerTileEntity(Register<TileEntityType<?>> event) {
         event.getRegistry().register(net.minecraft.tileentity.TileEntityType.Builder.func_223042_a(RedstoneClockOffBlock.CustomTileEntity::new, new Block[]{RedstoneClockOffBlock.block}).func_206865_a((Type)null).setRegistryName("redstone_clock_off"));
      }
