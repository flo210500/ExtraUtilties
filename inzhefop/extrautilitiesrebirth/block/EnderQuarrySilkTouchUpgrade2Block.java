...
public class EnderQuarrySilkTouchUpgrade2Block extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:ender_quarry_silk_touch_upgrade_2")
   public static final Block block = null;

   public EnderQuarrySilkTouchUpgrade2Block(ExtrautilitiesrebirthModElements instance) {
      super(instance, 109);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new EnderQuarrySilkTouchUpgrade2Block.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         super(net.minecraft.block.AbstractBlock.Properties.func_200945_a(Material.field_151573_f).func_200947_a(SoundType.field_185852_e).func_200948_a(1.5F, 100.0F).func_235838_a_((s) -> {
            return 0;
         }).harvestLevel(2).harvestTool(ToolType.PICKAXE).func_235861_h_().func_226896_b_().func_235828_a_((bs, br, bp) -> {
            return false;
         }));
         this.setRegistryName("ender_quarry_silk_touch_upgrade_2");
      }
      ...
      public void func_190948_a(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
         ...
         list.add(new StringTextComponent("§7Enchanter: Speed I Upgrade + Tool [Enchantment: efficiency >= 3]"));
      }
