...
public class MachineBlockBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:machine_block")
   public static final Block block = null;

   public MachineBlockBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 115);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new MachineBlockBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      ...
      public CustomBlock() {
         super(net.minecraft.block.AbstractBlock.Properties.func_200945_a(Material.field_151573_f).func_200947_a(SoundType.field_185852_e).func_200948_a(2.0F, 120.0F).func_235838_a_((s) -> {
            return 0;
         }).harvestLevel(2).harvestTool(ToolType.PICKAXE));
         this.func_180632_j((BlockState)((BlockState)this.field_176227_L.func_177621_b()).func_206870_a(FACING, Direction.NORTH));
         this.setRegistryName("machine_block");
      }
