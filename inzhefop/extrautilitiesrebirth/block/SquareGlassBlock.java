...
public class SquareGlassBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:square_glass")
   public static final Block block = null;

   public SquareGlassBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 66);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new SquareGlassBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("square_glass");
      }
