...
public class CompressedCobblestoneBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:compressed_cobblestone")
   public static final Block block = null;

   public CompressedCobblestoneBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 18);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new CompressedCobblestoneBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      ...
      public void func_190948_a(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
         ...
         list.add(new StringTextComponent("§79 Blocks"));
      }
