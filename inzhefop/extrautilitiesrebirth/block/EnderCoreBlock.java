...
public class EnderCoreBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:ender_core")
   public static final Block block = null;

   public EnderCoreBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 41);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new EnderCoreBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      ...
      public CustomBlock() {
         super(net.minecraft.block.AbstractBlock.Properties.func_200945_a(Material.field_151576_e).func_200947_a(SoundType.field_185851_d).func_200948_a(3.0F, 800.0F).func_235838_a_((s) -> {
            return 0;
         }).harvestLevel(2).harvestTool(ToolType.PICKAXE));
         this.func_180632_j((BlockState)((BlockState)this.field_176227_L.func_177621_b()).func_206870_a(FACING, Direction.NORTH));
         this.setRegistryName("ender_core");
      }
