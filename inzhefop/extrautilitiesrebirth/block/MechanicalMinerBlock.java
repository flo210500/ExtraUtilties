...
import inzhefop.extrautilitiesrebirth.gui.MechanicalMinerGUIGui;
...
public class MechanicalMinerBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:mechanical_miner")
   public static final Block block = null;
   @ObjectHolder("extrautilitiesrebirth:mechanical_miner")
   public static final TileEntityType<MechanicalMinerBlock.CustomTileEntity> tileEntityType = null;

   public MechanicalMinerBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 97);
      FMLJavaModLoadingContext.get().getModEventBus().register(new MechanicalMinerBlock.TileEntityRegisterHandler());
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new MechanicalMinerBlock.CustomBlock();
      });
   ...
   public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
      ...
      protected CustomTileEntity() {
         super(MechanicalMinerBlock.tileEntityType);
      ...
      public ITextComponent func_213907_g() {
         return new StringTextComponent("mechanical_miner");
      }
      ...
      public Container func_213906_a(int id, PlayerInventory player) {
         return new MechanicalMinerGUIGui.GuiContainerMod(id, player, (new PacketBuffer(Unpooled.buffer())).func_179255_a(this.func_174877_v()));
      }
   ...
   public static class CustomBlock extends Block {
      ...
      public CustomBlock() {
         ...
         this.setRegistryName("mechanical_miner");
      }
      ...
      public List<ItemStack> func_220076_a(BlockState state, net.minecraft.loot.LootContext.Builder builder) {
         ...
         return !dropsOriginal.isEmpty() ? dropsOriginal : Collections.singletonList(new ItemStack(MechanicalMinerBlock.block));
      }
      ...
      public void func_225534_a_(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
         ...
         int y = pos.func_177956_o();
         int z = pos.func_177952_p();
         MechanicalMinerUpdateTickProcedure.executeProcedure((Map)Stream.of(new SimpleEntry("world", world), new SimpleEntry("x", x), new SimpleEntry("y", y), new SimpleEntry("z", z)).collect(HashMap::new, (_m, _e) -> {
         ...
         if (entity instanceof ServerPlayerEntity) {
            NetworkHooks.openGui((ServerPlayerEntity)entity, new INamedContainerProvider() {
               ...
               public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
                  return new MechanicalMinerGUIGui.GuiContainerMod(id, inventory, (new PacketBuffer(Unpooled.buffer())).func_179255_a(new BlockPos(x, y, z)));
               }
            }, new BlockPos(x, y, z));
         }
      ...
      public TileEntity createTileEntity(BlockState state, IBlockReader world) {
         return new MechanicalMinerBlock.CustomTileEntity();
      }
      ...
      public void func_196243_a(BlockState state, World world, BlockPos pos, BlockState newState, boolean isMoving) {
         if (state.func_177230_c() != newState.func_177230_c()) {
            TileEntity tileentity = world.func_175625_s(pos);
            if (tileentity instanceof MechanicalMinerBlock.CustomTileEntity) {
               InventoryHelper.func_180175_a(world, pos, (MechanicalMinerBlock.CustomTileEntity)tileentity);
      ...
      public int func_180641_l(BlockState blockState, World world, BlockPos pos) {
         TileEntity tileentity = world.func_175625_s(pos);
         return tileentity instanceof MechanicalMinerBlock.CustomTileEntity ? Container.func_94526_b((MechanicalMinerBlock.CustomTileEntity)tileentity) : 0;
      }
   ...
   private static class TileEntityRegisterHandler {
      ...
      public void registerTileEntity(Register<TileEntityType<?>> event) {
         event.getRegistry().register(net.minecraft.tileentity.TileEntityType.Builder.func_223042_a(MechanicalMinerBlock.CustomTileEntity::new, new Block[]{MechanicalMinerBlock.block}).func_206865_a((Type)null).setRegistryName("mechanical_miner"));
      }
