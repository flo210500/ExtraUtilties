...
public class SolarPanelBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:solar_panel")
   public static final Block block = null;
   @ObjectHolder("extrautilitiesrebirth:solar_panel")
   public static final TileEntityType<SolarPanelBlock.CustomTileEntity> tileEntityType = null;

   public SolarPanelBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 51);
      FMLJavaModLoadingContext.get().getModEventBus().register(new SolarPanelBlock.TileEntityRegisterHandler());
   }
   ...
   public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
      ...
      protected CustomTileEntity() {
         super(SolarPanelBlock.tileEntityType);
   ...
   public static class CustomBlock extends Block {
      ...
      public CustomBlock() {
         super(net.minecraft.block.AbstractBlock.Properties.func_200945_a(Material.field_151573_f).func_200947_a(SoundType.field_185852_e).func_200948_a(1.0F, 10.0F).func_235838_a_((s) -> {
            return 0;
         ...
         this.setRegistryName("solar_panel");
      }
      ...
      public void func_225534_a_(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
         ...
         int y = pos.func_177956_o();
         int z = pos.func_177952_p();
         SolarPanelUpdateTickProcedure.executeProcedure((Map)Stream.of(new SimpleEntry("world", world), new SimpleEntry("x", x), new SimpleEntry("y", y), new SimpleEntry("z", z)).collect(HashMap::new, (_m, _e) -> {
      ...
      public TileEntity createTileEntity(BlockState state, IBlockReader world) {
         return new SolarPanelBlock.CustomTileEntity();
      }
      ...
      public void func_196243_a(BlockState state, World world, BlockPos pos, BlockState newState, boolean isMoving) {
         if (state.func_177230_c() != newState.func_177230_c()) {
            TileEntity tileentity = world.func_175625_s(pos);
            if (tileentity instanceof SolarPanelBlock.CustomTileEntity) {
               InventoryHelper.func_180175_a(world, pos, (SolarPanelBlock.CustomTileEntity)tileentity);
      ...
      public int func_180641_l(BlockState blockState, World world, BlockPos pos) {
         TileEntity tileentity = world.func_175625_s(pos);
         return tileentity instanceof SolarPanelBlock.CustomTileEntity ? Container.func_94526_b((SolarPanelBlock.CustomTileEntity)tileentity) : 0;
      }
   ...
   private static class TileEntityRegisterHandler {
      ...
      public void registerTileEntity(Register<TileEntityType<?>> event) {
         event.getRegistry().register(net.minecraft.tileentity.TileEntityType.Builder.func_223042_a(SolarPanelBlock.CustomTileEntity::new, new Block[]{SolarPanelBlock.block}).func_206865_a((Type)null).setRegistryName("solar_panel"));
      }
