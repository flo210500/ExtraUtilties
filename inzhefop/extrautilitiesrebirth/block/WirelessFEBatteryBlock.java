...
public class WirelessFEBatteryBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:wireless_fe_battery")
   public static final Block block = null;
   @ObjectHolder("extrautilitiesrebirth:wireless_fe_battery")
   public static final TileEntityType<WirelessFEBatteryBlock.CustomTileEntity> tileEntityType = null;

   public WirelessFEBatteryBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 103);
      FMLJavaModLoadingContext.get().getModEventBus().register(new WirelessFEBatteryBlock.TileEntityRegisterHandler());
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new WirelessFEBatteryBlock.CustomBlock();
      });
   ...
   public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
      ...
      protected CustomTileEntity() {
         super(WirelessFEBatteryBlock.tileEntityType);
         ...
         this.energyStorage = new EnergyStorage(3300, 3300, 3300, 0) {
      ...
      public ITextComponent func_213907_g() {
         return new StringTextComponent("wireless_fe_battery");
      }
      ...
      public ITextComponent func_145748_c_() {
         return new StringTextComponent("Wireless FE Battery");
      }
   ...
   public static class CustomBlock extends Block {
      ...
      public CustomBlock() {
         super(net.minecraft.block.AbstractBlock.Properties.func_200945_a(Material.field_151573_f).func_200947_a(SoundType.field_185852_e).func_200948_a(1.5F, 45.0F).func_235838_a_((s) -> {
            return 4;
         }).harvestLevel(2).harvestTool(ToolType.PICKAXE));
         this.func_180632_j((BlockState)((BlockState)this.field_176227_L.func_177621_b()).func_206870_a(FACING, Direction.NORTH));
         this.setRegistryName("wireless_fe_battery");
      }
      ...
      public void func_190948_a(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
         ...
         list.add(new StringTextComponent("§7To establish a connection use a wrench to (shift)right click on an block with energy storage then (shift) right click on the wireless fe battery to establish a connection!"));
         list.add(new StringTextComponent("§7Range: 10 Blocks!"));
      }
      ...
      public void func_225534_a_(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
         ...
         int y = pos.func_177956_o();
         int z = pos.func_177952_p();
         WirelessFEBatteryUpdateTickProcedure.executeProcedure((Map)Stream.of(new SimpleEntry("world", world), new SimpleEntry("x", x), new SimpleEntry("y", y), new SimpleEntry("z", z)).collect(HashMap::new, (_m, _e) -> {
      ...
      public ActionResultType func_225533_a_(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand, BlockRayTraceResult hit) {
         ...
         WirelessFEBatteryOnBlockRightClickedProcedure.executeProcedure((Map)Stream.of(new SimpleEntry("world", world), new SimpleEntry("x", x), new SimpleEntry("y", y), new SimpleEntry("z", z), new SimpleEntry("entity", entity)).collect(HashMap::new, (_m, _e) -> {
            _m.put(_e.getKey(), _e.getValue());
         }, Map::putAll));
      ...
      public TileEntity createTileEntity(BlockState state, IBlockReader world) {
         return new WirelessFEBatteryBlock.CustomTileEntity();
      }
      ...
      public void func_196243_a(BlockState state, World world, BlockPos pos, BlockState newState, boolean isMoving) {
         if (state.func_177230_c() != newState.func_177230_c()) {
            TileEntity tileentity = world.func_175625_s(pos);
            if (tileentity instanceof WirelessFEBatteryBlock.CustomTileEntity) {
               InventoryHelper.func_180175_a(world, pos, (WirelessFEBatteryBlock.CustomTileEntity)tileentity);
      ...
      public int func_180641_l(BlockState blockState, World world, BlockPos pos) {
         TileEntity tileentity = world.func_175625_s(pos);
         return tileentity instanceof WirelessFEBatteryBlock.CustomTileEntity ? Container.func_94526_b((WirelessFEBatteryBlock.CustomTileEntity)tileentity) : 0;
      }
   ...
   private static class TileEntityRegisterHandler {
      ...
      public void registerTileEntity(Register<TileEntityType<?>> event) {
         event.getRegistry().register(net.minecraft.tileentity.TileEntityType.Builder.func_223042_a(WirelessFEBatteryBlock.CustomTileEntity::new, new Block[]{WirelessFEBatteryBlock.block}).func_206865_a((Type)null).setRegistryName("wireless_fe_battery"));
      }
