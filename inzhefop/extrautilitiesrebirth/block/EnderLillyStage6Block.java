...
public class EnderLillyStage6Block extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:ender_lilly_stage_6")
   public static final Block block = null;

   public EnderLillyStage6Block(ExtrautilitiesrebirthModElements instance) {
      super(instance, 166);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new EnderLillyStage6Block.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("ender_lilly_stage_6");
      }
