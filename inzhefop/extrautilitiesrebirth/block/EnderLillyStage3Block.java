...
public class EnderLillyStage3Block extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:ender_lilly_stage_3")
   public static final Block block = null;

   public EnderLillyStage3Block(ExtrautilitiesrebirthModElements instance) {
      super(instance, 163);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new EnderLillyStage3Block.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("ender_lilly_stage_3");
      }
