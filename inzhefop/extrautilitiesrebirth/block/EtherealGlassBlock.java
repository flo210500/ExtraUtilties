...
public class EtherealGlassBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:ethereal_glass")
   public static final Block block = null;

   public EtherealGlassBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 56);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new EtherealGlassBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("ethereal_glass");
      }
