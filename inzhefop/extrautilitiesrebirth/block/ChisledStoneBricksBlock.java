...
public class ChisledStoneBricksBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:chisled_stone_bricks")
   public static final Block block = null;

   public ChisledStoneBricksBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 10);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new ChisledStoneBricksBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("chisled_stone_bricks");
      }
