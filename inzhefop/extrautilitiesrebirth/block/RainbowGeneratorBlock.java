...
public class RainbowGeneratorBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:rainbow_generator")
   public static final Block block = null;
   @ObjectHolder("extrautilitiesrebirth:rainbow_generator")
   public static final TileEntityType<RainbowGeneratorBlock.CustomTileEntity> tileEntityType = null;

   public RainbowGeneratorBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 88);
      FMLJavaModLoadingContext.get().getModEventBus().register(new RainbowGeneratorBlock.TileEntityRegisterHandler());
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new RainbowGeneratorBlock.CustomBlock();
      });
   ...
   public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
      ...
      protected CustomTileEntity() {
         super(RainbowGeneratorBlock.tileEntityType);
         ...
         this.energyStorage = new EnergyStorage(100000000, 25000000, 25000000, 0) {
      ...
      public ITextComponent func_213907_g() {
         return new StringTextComponent("rainbow_generator");
      }
      ...
      public ITextComponent func_145748_c_() {
         return new StringTextComponent("Rainbow Generator");
      }
   ...
   public static class CustomBlock extends Block {
      ...
      public CustomBlock() {
         super(net.minecraft.block.AbstractBlock.Properties.func_200945_a(Material.field_151573_f).func_200947_a(SoundType.field_185852_e).func_200948_a(5.0F, 8000.0F).func_235838_a_((s) -> {
            return 10;
         }).harvestLevel(3).harvestTool(ToolType.PICKAXE).func_235852_d_((bs, br, bp) -> {
            return true;
         }).func_235856_e_((bs, br, bp) -> {
            return true;
         }));
         this.func_180632_j((BlockState)((BlockState)this.field_176227_L.func_177621_b()).func_206870_a(FACING, Direction.NORTH));
         this.setRegistryName("rainbow_generator");
      }
      ...
      public void func_225534_a_(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
         ...
         int y = pos.func_177956_o();
         int z = pos.func_177952_p();
         RainbowGeneratorUpdateTickProcedure.executeProcedure((Map)Stream.of(new SimpleEntry("world", world), new SimpleEntry("x", x), new SimpleEntry("y", y), new SimpleEntry("z", z)).collect(HashMap::new, (_m, _e) -> {
      ...
      public ActionResultType func_225533_a_(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand, BlockRayTraceResult hit) {
         ...
         RainbowGeneratorOnBlockRightClickedProcedure.executeProcedure((Map)Stream.of(new SimpleEntry("world", world), new SimpleEntry("x", x), new SimpleEntry("y", y), new SimpleEntry("z", z), new SimpleEntry("entity", entity)).collect(HashMap::new, (_m, _e) -> {
            _m.put(_e.getKey(), _e.getValue());
         }, Map::putAll));
      ...
      public TileEntity createTileEntity(BlockState state, IBlockReader world) {
         return new RainbowGeneratorBlock.CustomTileEntity();
      }
      ...
      public void func_196243_a(BlockState state, World world, BlockPos pos, BlockState newState, boolean isMoving) {
         if (state.func_177230_c() != newState.func_177230_c()) {
            TileEntity tileentity = world.func_175625_s(pos);
            if (tileentity instanceof RainbowGeneratorBlock.CustomTileEntity) {
               InventoryHelper.func_180175_a(world, pos, (RainbowGeneratorBlock.CustomTileEntity)tileentity);
      ...
      public int func_180641_l(BlockState blockState, World world, BlockPos pos) {
         TileEntity tileentity = world.func_175625_s(pos);
         return tileentity instanceof RainbowGeneratorBlock.CustomTileEntity ? Container.func_94526_b((RainbowGeneratorBlock.CustomTileEntity)tileentity) : 0;
      }
   ...
   private static class TileEntityRegisterHandler {
      ...
      public void registerTileEntity(Register<TileEntityType<?>> event) {
         event.getRegistry().register(net.minecraft.tileentity.TileEntityType.Builder.func_223042_a(RainbowGeneratorBlock.CustomTileEntity::new, new Block[]{RainbowGeneratorBlock.block}).func_206865_a((Type)null).setRegistryName("rainbow_generator"));
      }
