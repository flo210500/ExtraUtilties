...
public class ResonantorGUIGui extends ExtrautilitiesrebirthModElements.ModElement {
   public static HashMap guistate = new HashMap();
   private static ContainerType<ResonantorGUIGui.GuiContainerMod> containerType = null;

   public ResonantorGUIGui(ExtrautilitiesrebirthModElements instance) {
      super(instance, 224);
      this.elements.addNetworkMessage(ResonantorGUIGui.ButtonPressedMessage.class, ResonantorGUIGui.ButtonPressedMessage::buffer, ResonantorGUIGui.ButtonPressedMessage::new, ResonantorGUIGui.ButtonPressedMessage::handler);
      this.elements.addNetworkMessage(ResonantorGUIGui.GUISlotChangedMessage.class, ResonantorGUIGui.GUISlotChangedMessage::buffer, ResonantorGUIGui.GUISlotChangedMessage::new, ResonantorGUIGui.GUISlotChangedMessage::handler);
      containerType = new ContainerType(new ResonantorGUIGui.GuiContainerModFactory());
      FMLJavaModLoadingContext.get().getModEventBus().register(new ResonantorGUIGui.ContainerRegisterHandler());
   }

   @OnlyIn(Dist.CLIENT)
   public void initElements() {
      DeferredWorkQueue.runLater(() -> {
         ScreenManager.func_216911_a(containerType, ResonantorGUIGuiWindow::new);
      });
   }
   ...
   public static class GUISlotChangedMessage {
      ...
      public static void buffer(ResonantorGUIGui.GUISlotChangedMessage message, PacketBuffer buffer) {
      ...
      public static void handler(ResonantorGUIGui.GUISlotChangedMessage message, Supplier<Context> contextSupplier) {
         ...
         context.enqueueWork(() -> {
            ...
            int y = message.y;
            int z = message.z;
            ResonantorGUIGui.handleSlotAction(entity, slotID, changeType, meta, x, y, z);
         });
   ...
   public static class ButtonPressedMessage {
      ...
      public static void buffer(ResonantorGUIGui.ButtonPressedMessage message, PacketBuffer buffer) {
      ...
      public static void handler(ResonantorGUIGui.ButtonPressedMessage message, Supplier<Context> contextSupplier) {
         Context context = (Context)contextSupplier.get();
         context.enqueueWork(() -> {
            PlayerEntity entity = context.getSender();
            ...
            int y = message.y;
            int z = message.z;
            ResonantorGUIGui.handleButtonAction(entity, buttonID, x, y, z);
         });
         context.setPacketHandled(true);
      }
   }
   ...
   public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
      ...
      public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
         super(ResonantorGUIGui.containerType, id);
         ...
         this.customSlots.put(0, this.func_75146_a(new SlotItemHandler(this.internal, 0, 45, 34) {
         }));
         this.customSlots.put(1, this.func_75146_a(new SlotItemHandler(this.internal, 1, 98, 34) {
            public boolean func_75214_a(ItemStack stack) {
               return false;
            }
         }));
         this.customSlots.put(2, this.func_75146_a(new SlotItemHandler(this.internal, 2, 8, 19) {
         }));
      ...
      private void slotChanged(int slotid, int ctype, int meta) {
         if (this.world != null && this.world.func_201670_d()) {
            ExtrautilitiesrebirthMod.PACKET_HANDLER.sendToServer(new ResonantorGUIGui.GUISlotChangedMessage(slotid, this.x, this.y, this.z, ctype, meta));
            ResonantorGUIGui.handleSlotAction(this.entity, slotid, ctype, meta, this.x, this.y, this.z);
         }
   ...
   public static class GuiContainerModFactory implements IContainerFactory {
      public ResonantorGUIGui.GuiContainerMod create(int id, PlayerInventory inv, PacketBuffer extraData) {
         return new ResonantorGUIGui.GuiContainerMod(id, inv, extraData);
      }
   }
   ...
   private static class ContainerRegisterHandler {
      ...
      public void registerContainer(Register<ContainerType<?>> event) {
         event.getRegistry().register(ResonantorGUIGui.containerType.setRegistryName("resonantor_gui"));
      }
