...
public class GoldenChestGUIGui extends ExtrautilitiesrebirthModElements.ModElement {
   public static HashMap guistate = new HashMap();
   private static ContainerType<GoldenChestGUIGui.GuiContainerMod> containerType = null;

   public GoldenChestGUIGui(ExtrautilitiesrebirthModElements instance) {
      super(instance, 406);
      this.elements.addNetworkMessage(GoldenChestGUIGui.ButtonPressedMessage.class, GoldenChestGUIGui.ButtonPressedMessage::buffer, GoldenChestGUIGui.ButtonPressedMessage::new, GoldenChestGUIGui.ButtonPressedMessage::handler);
      this.elements.addNetworkMessage(GoldenChestGUIGui.GUISlotChangedMessage.class, GoldenChestGUIGui.GUISlotChangedMessage::buffer, GoldenChestGUIGui.GUISlotChangedMessage::new, GoldenChestGUIGui.GUISlotChangedMessage::handler);
      containerType = new ContainerType(new GoldenChestGUIGui.GuiContainerModFactory());
      FMLJavaModLoadingContext.get().getModEventBus().register(new GoldenChestGUIGui.ContainerRegisterHandler());
   }

   @OnlyIn(Dist.CLIENT)
   public void initElements() {
      DeferredWorkQueue.runLater(() -> {
         ScreenManager.func_216911_a(containerType, GoldenChestGUIGuiWindow::new);
      });
   }
   ...
   public static class GUISlotChangedMessage {
      ...
      public static void buffer(GoldenChestGUIGui.GUISlotChangedMessage message, PacketBuffer buffer) {
      ...
      public static void handler(GoldenChestGUIGui.GUISlotChangedMessage message, Supplier<Context> contextSupplier) {
         ...
         context.enqueueWork(() -> {
            ...
            int y = message.y;
            int z = message.z;
            GoldenChestGUIGui.handleSlotAction(entity, slotID, changeType, meta, x, y, z);
         });
   ...
   public static class ButtonPressedMessage {
      ...
      public static void buffer(GoldenChestGUIGui.ButtonPressedMessage message, PacketBuffer buffer) {
      ...
      public static void handler(GoldenChestGUIGui.ButtonPressedMessage message, Supplier<Context> contextSupplier) {
         Context context = (Context)contextSupplier.get();
         context.enqueueWork(() -> {
            PlayerEntity entity = context.getSender();
            ...
            int y = message.y;
            int z = message.z;
            GoldenChestGUIGui.handleButtonAction(entity, buttonID, x, y, z);
         });
         context.setPacketHandled(true);
      }
   }
   ...
   public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
      ...
      public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
         super(GoldenChestGUIGui.containerType, id);
      ...
      private void slotChanged(int slotid, int ctype, int meta) {
         if (this.world != null && this.world.func_201670_d()) {
            ExtrautilitiesrebirthMod.PACKET_HANDLER.sendToServer(new GoldenChestGUIGui.GUISlotChangedMessage(slotid, this.x, this.y, this.z, ctype, meta));
            GoldenChestGUIGui.handleSlotAction(this.entity, slotid, ctype, meta, this.x, this.y, this.z);
         }
   ...
   public static class GuiContainerModFactory implements IContainerFactory {
      public GoldenChestGUIGui.GuiContainerMod create(int id, PlayerInventory inv, PacketBuffer extraData) {
         return new GoldenChestGUIGui.GuiContainerMod(id, inv, extraData);
      }
   }
   ...
   private static class ContainerRegisterHandler {
      ...
      public void registerContainer(Register<ContainerType<?>> event) {
         event.getRegistry().register(GoldenChestGUIGui.containerType.setRegistryName("golden_chest_gui"));
      }
