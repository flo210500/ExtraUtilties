...
@OnlyIn(Dist.CLIENT)
public class CreativeChestGUIGuiWindow extends ContainerScreen<CreativeChestGUIGui.GuiContainerMod> {
   private World world;
   private int x;
   private int y;
   private int z;
   ...
   public CreativeChestGUIGuiWindow(CreativeChestGUIGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
   ...
   protected void func_230450_a_(MatrixStack ms, float partialTicks, int gx, int gy) {
      ...
      func_238463_a_(ms, this.field_147003_i + 71, this.field_147009_r + 34, 0.0F, 0.0F, 32, 18, 32, 18);
   ...
   protected void func_230451_b_(MatrixStack ms, int mouseX, int mouseY) {
      this.field_230712_o_.func_238421_b_(ms, "Creative Chest", 6.0F, 5.0F, -12829636);
   ...
   static {
      guistate = CreativeChestGUIGui.guistate;
      texture = new ResourceLocation("extrautilitiesrebirth:textures/screens/creative_chest_gui.png");
   }
}
