...
@OnlyIn(Dist.CLIENT)
public class ResonantorGUIGuiWindow extends ContainerScreen<ResonantorGUIGui.GuiContainerMod> {
   private World world;
   private int x;
   private int y;
   private int z;
   ...
   public ResonantorGUIGuiWindow(ResonantorGUIGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
   ...
   protected void func_230450_a_(MatrixStack ms, float partialTicks, int gx, int gy) {
      ...
      func_238463_a_(ms, this.field_147003_i + 62, this.field_147009_r + 33, 0.0F, 0.0F, 32, 18, 32, 18);
      ...
      })).getValue(this.world, new BlockPos(this.x, this.y, this.z), "ticks") * 22.0D / 100.0D;
      if (fdf > 22.0D) {
         fdf = 22.0D;
      }
      ...
      func_238463_a_(ms, this.field_147003_i + 68, this.field_147009_r + 34, 0.0F, 0.0F, pg, 15, pg, 15);
      ...
      func_238463_a_(ms, this.field_147003_i + 68, this.field_147009_r + 34, 0.0F, 0.0F, 22, 15, 22, 15);
   ...
   protected void func_230451_b_(MatrixStack ms, int mouseX, int mouseY) {
      this.field_230712_o_.func_238421_b_(ms, "Inventory", 7.0F, 71.0F, -12829636);
      this.field_230712_o_.func_238421_b_(ms, "Resonator", 7.0F, 4.0F, -12829636);
   }
   ...
   static {
      guistate = ResonantorGUIGui.guistate;
      texture = new ResourceLocation("extrautilitiesrebirth:textures/screens/resonantor_gui.png");
   }
}
