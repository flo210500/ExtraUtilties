...
@OnlyIn(Dist.CLIENT)
public class EnchanterGUIGuiWindow extends ContainerScreen<EnchanterGUIGui.GuiContainerMod> {
   private World world;
   private int x;
   private int y;
   private int z;
   ...
   public EnchanterGUIGuiWindow(EnchanterGUIGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
   ...
   protected void func_230450_a_(MatrixStack ms, float partialTicks, int gx, int gy) {
      ...
      Minecraft.func_71410_x().func_110434_K().func_110577_a(new ResourceLocation("extrautilitiesrebirth:textures/screens/progress_arrow_back.png"));
      func_238463_a_(ms, this.field_147003_i + 78, this.field_147009_r + 35, 0.0F, 0.0F, 22, 15, 22, 15);
      double fdf = ((<undefinedtype>)(new Object() {
         public double getValue(IWorld world, BlockPos pos, String tag) {
            TileEntity tileEntity = world.func_175625_s(pos);
            return tileEntity != null ? tileEntity.getTileData().func_74769_h(tag) : -1.0D;
         }
      })).getValue(this.world, new BlockPos(this.x, this.y, this.z), "progress") * 22.0D / ((<undefinedtype>)(new Object() {
         public double getValue(IWorld world, BlockPos pos, String tag) {
            TileEntity tileEntity = world.func_175625_s(pos);
            return tileEntity != null ? tileEntity.getTileData().func_74769_h(tag) : -1.0D;
         }
      })).getValue(this.world, new BlockPos(this.x, this.y, this.z), "progresstime");
      if (fdf > 22.0D) {
         fdf = 22.0D;
      }
      ...
      func_238463_a_(ms, this.field_147003_i + 78, this.field_147009_r + 35, 0.0F, 0.0F, pg, 15, pg, 15);
   ...
   protected void func_230451_b_(MatrixStack ms, int mouseX, int mouseY) {
      ...
      this.field_230712_o_.func_238421_b_(ms, "Enchanter", 7.0F, 5.0F, -12829636);
   }
   ...
   static {
      guistate = EnchanterGUIGui.guistate;
      texture = new ResourceLocation("extrautilitiesrebirth:textures/screens/enchanter_gui.png");
   }
}
