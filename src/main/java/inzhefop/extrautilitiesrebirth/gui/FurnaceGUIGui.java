...
public class FurnaceGUIGui extends ExtrautilitiesrebirthModElements.ModElement {
   public static HashMap guistate = new HashMap();
   private static ContainerType<FurnaceGUIGui.GuiContainerMod> containerType = null;

   public FurnaceGUIGui(ExtrautilitiesrebirthModElements instance) {
      super(instance, 228);
      this.elements.addNetworkMessage(FurnaceGUIGui.ButtonPressedMessage.class, FurnaceGUIGui.ButtonPressedMessage::buffer, FurnaceGUIGui.ButtonPressedMessage::new, FurnaceGUIGui.ButtonPressedMessage::handler);
      this.elements.addNetworkMessage(FurnaceGUIGui.GUISlotChangedMessage.class, FurnaceGUIGui.GUISlotChangedMessage::buffer, FurnaceGUIGui.GUISlotChangedMessage::new, FurnaceGUIGui.GUISlotChangedMessage::handler);
      containerType = new ContainerType(new FurnaceGUIGui.GuiContainerModFactory());
      FMLJavaModLoadingContext.get().getModEventBus().register(new FurnaceGUIGui.ContainerRegisterHandler());
   }

   @OnlyIn(Dist.CLIENT)
   public void initElements() {
      DeferredWorkQueue.runLater(() -> {
         ScreenManager.func_216911_a(containerType, FurnaceGUIGuiWindow::new);
      });
   }
   ...
   public static class GUISlotChangedMessage {
      ...
      public static void buffer(FurnaceGUIGui.GUISlotChangedMessage message, PacketBuffer buffer) {
      ...
      public static void handler(FurnaceGUIGui.GUISlotChangedMessage message, Supplier<Context> contextSupplier) {
         ...
         context.enqueueWork(() -> {
            ...
            int y = message.y;
            int z = message.z;
            FurnaceGUIGui.handleSlotAction(entity, slotID, changeType, meta, x, y, z);
         });
   ...
   public static class ButtonPressedMessage {
      ...
      public static void buffer(FurnaceGUIGui.ButtonPressedMessage message, PacketBuffer buffer) {
      ...
      public static void handler(FurnaceGUIGui.ButtonPressedMessage message, Supplier<Context> contextSupplier) {
         Context context = (Context)contextSupplier.get();
         context.enqueueWork(() -> {
            PlayerEntity entity = context.getSender();
            ...
            int y = message.y;
            int z = message.z;
            FurnaceGUIGui.handleButtonAction(entity, buttonID, x, y, z);
         });
         context.setPacketHandled(true);
      }
   }
   ...
   public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
      ...
      public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
         super(FurnaceGUIGui.containerType, id);
         ...
         this.customSlots.put(0, this.func_75146_a(new SlotItemHandler(this.internal, 0, 44, 33) {
         }));
         this.customSlots.put(1, this.func_75146_a(new SlotItemHandler(this.internal, 1, 98, 33) {
            public boolean func_75214_a(ItemStack stack) {
               return false;
            }
         }));
         this.customSlots.put(2, this.func_75146_a(new SlotItemHandler(this.internal, 2, 8, 18) {
         }));
      ...
      private void slotChanged(int slotid, int ctype, int meta) {
         if (this.world != null && this.world.func_201670_d()) {
            ExtrautilitiesrebirthMod.PACKET_HANDLER.sendToServer(new FurnaceGUIGui.GUISlotChangedMessage(slotid, this.x, this.y, this.z, ctype, meta));
            FurnaceGUIGui.handleSlotAction(this.entity, slotid, ctype, meta, this.x, this.y, this.z);
         }
   ...
   public static class GuiContainerModFactory implements IContainerFactory {
      public FurnaceGUIGui.GuiContainerMod create(int id, PlayerInventory inv, PacketBuffer extraData) {
         return new FurnaceGUIGui.GuiContainerMod(id, inv, extraData);
      }
   }
   ...
   private static class ContainerRegisterHandler {
      ...
      public void registerContainer(Register<ContainerType<?>> event) {
         event.getRegistry().register(FurnaceGUIGui.containerType.setRegistryName("furnace_gui"));
      }
