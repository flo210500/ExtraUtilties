...
@OnlyIn(Dist.CLIENT)
public class EnderQuarryGUIGuiWindow extends ContainerScreen<EnderQuarryGUIGui.GuiContainerMod> {
   private World world;
   private int x;
   private int y;
   private int z;
   ...
   public EnderQuarryGUIGuiWindow(EnderQuarryGUIGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
   ...
   protected void func_230451_b_(MatrixStack ms, int mouseX, int mouseY) {
      this.field_230712_o_.func_238421_b_(ms, "Quantum Quarry", 6.0F, 5.0F, -12829636);
   }
   ...
   static {
      guistate = EnderQuarryGUIGui.guistate;
      texture = new ResourceLocation("extrautilitiesrebirth:textures/screens/ender_quarry_gui.png");
   }
}
