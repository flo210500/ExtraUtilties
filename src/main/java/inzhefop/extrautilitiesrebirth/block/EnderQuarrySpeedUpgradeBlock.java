...
public class EnderQuarrySpeedUpgradeBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:ender_quarry_speed_upgrade")
   public static final Block block = null;

   public EnderQuarrySpeedUpgradeBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 108);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new EnderQuarrySpeedUpgradeBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("ender_quarry_speed_upgrade");
      }
