...
public class EnderQuarryWorldHoleUpgradeBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:ender_quarry_world_hole_upgrade")
   public static final Block block = null;

   public EnderQuarryWorldHoleUpgradeBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 106);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new EnderQuarryWorldHoleUpgradeBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("ender_quarry_world_hole_upgrade");
      }
