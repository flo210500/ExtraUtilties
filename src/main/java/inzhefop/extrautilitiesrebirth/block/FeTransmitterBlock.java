...
public class FeTransmitterBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:fe_transmitter")
   public static final Block block = null;
   @ObjectHolder("extrautilitiesrebirth:fe_transmitter")
   public static final TileEntityType<FeTransmitterBlock.CustomTileEntity> tileEntityType = null;

   public FeTransmitterBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 380);
      FMLJavaModLoadingContext.get().getModEventBus().register(new FeTransmitterBlock.TileEntityRegisterHandler());
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new FeTransmitterBlock.CustomBlock();
      });
   ...
   public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
      ...
      protected CustomTileEntity() {
         super(FeTransmitterBlock.tileEntityType);
         ...
         this.energyStorage = new EnergyStorage(3200, 3200, 3200, 0) {
      ...
      public ITextComponent func_213907_g() {
         return new StringTextComponent("fe_transmitter");
      }
      ...
      public ITextComponent func_145748_c_() {
         return new StringTextComponent("Fe Transmitter");
      }
   ...
   public static class CustomBlock extends Block {
      ...
      public CustomBlock() {
         super(net.minecraft.block.AbstractBlock.Properties.func_200945_a(Material.field_151576_e).func_200947_a(SoundType.field_185851_d).func_200948_a(1.0F, 15.0F).func_235838_a_((s) -> {
            return 0;
         }).harvestLevel(1).harvestTool(ToolType.PICKAXE).func_235861_h_().func_226896_b_().func_235828_a_((bs, br, bp) -> {
            return false;
         }));
         this.func_180632_j((BlockState)((BlockState)this.field_176227_L.func_177621_b()).func_206870_a(FACING, Direction.NORTH));
         this.setRegistryName("fe_transmitter");
      }
      ...
      public VoxelShape func_220053_a(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
         ...
         case SOUTH:
         default:
            return VoxelShapes.func_216384_a(func_208617_a(14.0D, 0.0D, 14.0D, 2.0D, 2.0D, 2.0D), new VoxelShape[0]).func_197751_a(offset.field_72450_a, offset.field_72448_b, offset.field_72449_c);
         case NORTH:
            return VoxelShapes.func_216384_a(func_208617_a(2.0D, 0.0D, 2.0D, 14.0D, 2.0D, 14.0D), new VoxelShape[0]).func_197751_a(offset.field_72450_a, offset.field_72448_b, offset.field_72449_c);
         case EAST:
            return VoxelShapes.func_216384_a(func_208617_a(14.0D, 0.0D, 2.0D, 2.0D, 2.0D, 14.0D), new VoxelShape[0]).func_197751_a(offset.field_72450_a, offset.field_72448_b, offset.field_72449_c);
         case WEST:
            return VoxelShapes.func_216384_a(func_208617_a(2.0D, 0.0D, 14.0D, 14.0D, 2.0D, 2.0D), new VoxelShape[0]).func_197751_a(offset.field_72450_a, offset.field_72448_b, offset.field_72449_c);
         }
      }
      ...
      public TileEntity createTileEntity(BlockState state, IBlockReader world) {
         return new FeTransmitterBlock.CustomTileEntity();
      }
      ...
      public void func_196243_a(BlockState state, World world, BlockPos pos, BlockState newState, boolean isMoving) {
         if (state.func_177230_c() != newState.func_177230_c()) {
            TileEntity tileentity = world.func_175625_s(pos);
            if (tileentity instanceof FeTransmitterBlock.CustomTileEntity) {
               InventoryHelper.func_180175_a(world, pos, (FeTransmitterBlock.CustomTileEntity)tileentity);
      ...
      public int func_180641_l(BlockState blockState, World world, BlockPos pos) {
         TileEntity tileentity = world.func_175625_s(pos);
         return tileentity instanceof FeTransmitterBlock.CustomTileEntity ? Container.func_94526_b((FeTransmitterBlock.CustomTileEntity)tileentity) : 0;
      }
   ...
   private static class TileEntityRegisterHandler {
      ...
      public void registerTileEntity(Register<TileEntityType<?>> event) {
         event.getRegistry().register(net.minecraft.tileentity.TileEntityType.Builder.func_223042_a(FeTransmitterBlock.CustomTileEntity::new, new Block[]{FeTransmitterBlock.block}).func_206865_a((Type)null).setRegistryName("fe_transmitter"));
      }
