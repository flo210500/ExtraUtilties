...
public class ReinforcedDrumBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:reinforced_drum")
   public static final Block block = null;
   @ObjectHolder("extrautilitiesrebirth:reinforced_drum")
   public static final TileEntityType<ReinforcedDrumBlock.CustomTileEntity> tileEntityType = null;

   public ReinforcedDrumBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 94);
      FMLJavaModLoadingContext.get().getModEventBus().register(new ReinforcedDrumBlock.TileEntityRegisterHandler());
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new ReinforcedDrumBlock.CustomBlock();
      });
   ...
   public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
      ...
      protected CustomTileEntity() {
         super(ReinforcedDrumBlock.tileEntityType);
         ...
         this.fluidTank = new FluidTank(4096000) {
      ...
      public ITextComponent func_213907_g() {
         return new StringTextComponent("reinforced_drum");
      }
      ...
      public ITextComponent func_145748_c_() {
         return new StringTextComponent("Reinforced Drum");
      }
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         super(net.minecraft.block.AbstractBlock.Properties.func_200945_a(Material.field_151573_f).func_200947_a(SoundType.field_185852_e).func_200948_a(2.0F, 350.0F).func_235838_a_((s) -> {
            return 0;
         }).harvestLevel(3).harvestTool(ToolType.PICKAXE).func_226896_b_().func_235828_a_((bs, br, bp) -> {
            return false;
         }));
         this.setRegistryName("reinforced_drum");
      }
      ...
      public TileEntity createTileEntity(BlockState state, IBlockReader world) {
         return new ReinforcedDrumBlock.CustomTileEntity();
      }
      ...
      public void func_196243_a(BlockState state, World world, BlockPos pos, BlockState newState, boolean isMoving) {
         if (state.func_177230_c() != newState.func_177230_c()) {
            TileEntity tileentity = world.func_175625_s(pos);
            if (tileentity instanceof ReinforcedDrumBlock.CustomTileEntity) {
               InventoryHelper.func_180175_a(world, pos, (ReinforcedDrumBlock.CustomTileEntity)tileentity);
      ...
      public int func_180641_l(BlockState blockState, World world, BlockPos pos) {
         TileEntity tileentity = world.func_175625_s(pos);
         return tileentity instanceof ReinforcedDrumBlock.CustomTileEntity ? Container.func_94526_b((ReinforcedDrumBlock.CustomTileEntity)tileentity) : 0;
      }
   }
   ...
   private static class TileEntityRegisterHandler {
      ...
      public void registerTileEntity(Register<TileEntityType<?>> event) {
         event.getRegistry().register(net.minecraft.tileentity.TileEntityType.Builder.func_223042_a(ReinforcedDrumBlock.CustomTileEntity::new, new Block[]{ReinforcedDrumBlock.block}).func_206865_a((Type)null).setRegistryName("reinforced_drum"));
      }
