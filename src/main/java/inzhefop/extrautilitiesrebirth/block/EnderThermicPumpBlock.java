...
public class EnderThermicPumpBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:ender_thermic_pump")
   public static final Block block = null;
   @ObjectHolder("extrautilitiesrebirth:ender_thermic_pump")
   public static final TileEntityType<EnderThermicPumpBlock.CustomTileEntity> tileEntityType = null;

   public EnderThermicPumpBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 90);
      FMLJavaModLoadingContext.get().getModEventBus().register(new EnderThermicPumpBlock.TileEntityRegisterHandler());
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new EnderThermicPumpBlock.CustomBlock();
      });
   ...
   public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
      ...
      protected CustomTileEntity() {
         super(EnderThermicPumpBlock.tileEntityType);
         ...
         this.fluidTank = new FluidTank(64000, (fs) -> {
            if (fs.getFluid() == Fluids.field_207212_b) {
               return true;
            } else if (fs.getFluid() == Fluids.field_204546_a) {
               return true;
            } else if (fs.getFluid() == Fluids.field_207213_d) {
               return true;
            } else {
               return fs.getFluid() == Fluids.field_204547_b;
            }
         }) {
      ...
      public ITextComponent func_213907_g() {
         return new StringTextComponent("ender_thermic_pump");
      }
      ...
      public ITextComponent func_145748_c_() {
         return new StringTextComponent("Ender Thermic Pump");
      }
      ...
      public <T> LazyOptional<T> getCapability(Capability<T> capability, @Nullable Direction facing) {
         ...
         } else if (!this.field_145846_f && capability == CapabilityEnergy.ENERGY) {
   ...
   public static class CustomBlock extends Block {
      ...
      public CustomBlock() {
         super(net.minecraft.block.AbstractBlock.Properties.func_200945_a(Material.field_151573_f).func_200947_a(SoundType.field_185852_e).func_200948_a(1.5F, 800.0F).func_235838_a_((s) -> {
            return 0;
         }).harvestLevel(2).harvestTool(ToolType.PICKAXE));
         this.func_180632_j((BlockState)((BlockState)this.field_176227_L.func_177621_b()).func_206870_a(FACING, Direction.NORTH));
         this.setRegistryName("ender_thermic_pump");
      }
      ...
      public void func_225534_a_(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
         ...
         int y = pos.func_177956_o();
         int z = pos.func_177952_p();
         PumpUpdateTickProcedure.executeProcedure((Map)Stream.of(new SimpleEntry("world", world), new SimpleEntry("x", x), new SimpleEntry("y", y), new SimpleEntry("z", z)).collect(HashMap::new, (_m, _e) -> {
            _m.put(_e.getKey(), _e.getValue());
         }, Map::putAll));
         world.func_205220_G_().func_205360_a(pos, this, 1);
      }
      ...
      public ActionResultType func_225533_a_(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand, BlockRayTraceResult hit) {
         ...
         PumpRightClickedProcedureProcedure.executeProcedure((Map)Stream.of(new SimpleEntry("world", world), new SimpleEntry("x", x), new SimpleEntry("y", y), new SimpleEntry("z", z), new SimpleEntry("entity", entity)).collect(HashMap::new, (_m, _e) -> {
            _m.put(_e.getKey(), _e.getValue());
         }, Map::putAll));
      ...
      public TileEntity createTileEntity(BlockState state, IBlockReader world) {
         return new EnderThermicPumpBlock.CustomTileEntity();
      }
      ...
      public void func_196243_a(BlockState state, World world, BlockPos pos, BlockState newState, boolean isMoving) {
         if (state.func_177230_c() != newState.func_177230_c()) {
            TileEntity tileentity = world.func_175625_s(pos);
            if (tileentity instanceof EnderThermicPumpBlock.CustomTileEntity) {
               InventoryHelper.func_180175_a(world, pos, (EnderThermicPumpBlock.CustomTileEntity)tileentity);
      ...
      public int func_180641_l(BlockState blockState, World world, BlockPos pos) {
         TileEntity tileentity = world.func_175625_s(pos);
         return tileentity instanceof EnderThermicPumpBlock.CustomTileEntity ? Container.func_94526_b((EnderThermicPumpBlock.CustomTileEntity)tileentity) : 0;
      }
   ...
   private static class TileEntityRegisterHandler {
      ...
      public void registerTileEntity(Register<TileEntityType<?>> event) {
         event.getRegistry().register(net.minecraft.tileentity.TileEntityType.Builder.func_223042_a(EnderThermicPumpBlock.CustomTileEntity::new, new Block[]{EnderThermicPumpBlock.block}).func_206865_a((Type)null).setRegistryName("ender_thermic_pump"));
      }
