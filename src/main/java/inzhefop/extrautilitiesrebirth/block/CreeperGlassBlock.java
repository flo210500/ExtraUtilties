...
public class CreeperGlassBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:creeper_glass")
   public static final Block block = null;

   public CreeperGlassBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 52);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new CreeperGlassBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("creeper_glass");
      }
