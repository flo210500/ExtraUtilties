...
public class QuantumQuarryBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:quantum_quarry")
   public static final Block block = null;
   @ObjectHolder("extrautilitiesrebirth:quantum_quarry")
   public static final TileEntityType<QuantumQuarryBlock.CustomTileEntity> tileEntityType = null;

   public QuantumQuarryBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 423);
      FMLJavaModLoadingContext.get().getModEventBus().register(new QuantumQuarryBlock.TileEntityRegisterHandler());
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new QuantumQuarryBlock.CustomBlock();
      });
   ...
   public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
      ...
      protected CustomTileEntity() {
         super(QuantumQuarryBlock.tileEntityType);
      ...
      public ITextComponent func_213907_g() {
         return new StringTextComponent("quantum_quarry");
      }
      ...
      public Container func_213906_a(int id, PlayerInventory player) {
         return new EnderQuarryGUIGui.GuiContainerMod(id, player, (new PacketBuffer(Unpooled.buffer())).func_179255_a(this.func_174877_v()));
      }

      public ITextComponent func_145748_c_() {
         return new StringTextComponent("Quantum Quarry");
      }
   ...
   public static class CustomBlock extends Block {
      ...
      public CustomBlock() {
         super(net.minecraft.block.AbstractBlock.Properties.func_200945_a(Material.field_151573_f).func_200947_a(SoundType.field_185852_e).func_200948_a(2.5F, 8000.0F).func_235838_a_((s) -> {
            return 0;
         ...
         this.setRegistryName("quantum_quarry");
      }
      ...
      public void func_220069_a(BlockState blockstate, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
         ...
         QuantumQuarryNeighbourBlockChangesProcedure.executeProcedure((Map)Stream.of(new SimpleEntry("world", world), new SimpleEntry("x", x), new SimpleEntry("y", y), new SimpleEntry("z", z)).collect(HashMap::new, (_m, _e) -> {
      ...
      public ActionResultType func_225533_a_(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand, BlockRayTraceResult hit) {
         ...
         QuantumQuarryOnBlockRightClickedProcedure.executeProcedure((Map)Stream.of(new SimpleEntry("world", world), new SimpleEntry("x", x), new SimpleEntry("y", y), new SimpleEntry("z", z), new SimpleEntry("entity", entity)).collect(HashMap::new, (_m, _e) -> {
            _m.put(_e.getKey(), _e.getValue());
         }, Map::putAll));
      ...
      public TileEntity createTileEntity(BlockState state, IBlockReader world) {
         return new QuantumQuarryBlock.CustomTileEntity();
      }
      ...
      public void func_196243_a(BlockState state, World world, BlockPos pos, BlockState newState, boolean isMoving) {
         if (state.func_177230_c() != newState.func_177230_c()) {
            TileEntity tileentity = world.func_175625_s(pos);
            if (tileentity instanceof QuantumQuarryBlock.CustomTileEntity) {
               InventoryHelper.func_180175_a(world, pos, (QuantumQuarryBlock.CustomTileEntity)tileentity);
      ...
      public int func_180641_l(BlockState blockState, World world, BlockPos pos) {
         TileEntity tileentity = world.func_175625_s(pos);
         return tileentity instanceof QuantumQuarryBlock.CustomTileEntity ? Container.func_94526_b((QuantumQuarryBlock.CustomTileEntity)tileentity) : 0;
      }
   ...
   private static class TileEntityRegisterHandler {
      ...
      public void registerTileEntity(Register<TileEntityType<?>> event) {
         event.getRegistry().register(net.minecraft.tileentity.TileEntityType.Builder.func_223042_a(QuantumQuarryBlock.CustomTileEntity::new, new Block[]{QuantumQuarryBlock.block}).func_206865_a((Type)null).setRegistryName("quantum_quarry"));
      }
