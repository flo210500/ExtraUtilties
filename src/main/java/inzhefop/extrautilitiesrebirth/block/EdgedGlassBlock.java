...
public class EdgedGlassBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:edged_glass")
   public static final Block block = null;

   public EdgedGlassBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 55);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new EdgedGlassBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("edged_glass");
      }
