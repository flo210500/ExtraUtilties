...
public class GoldenEdgedGlassBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:golden_edged_glass")
   public static final Block block = null;

   public GoldenEdgedGlassBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 60);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new GoldenEdgedGlassBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("golden_edged_glass");
      }
