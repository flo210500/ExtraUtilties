...
public class CreativeDrumBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:creative_drum")
   public static final Block block = null;
   @ObjectHolder("extrautilitiesrebirth:creative_drum")
   public static final TileEntityType<CreativeDrumBlock.CustomTileEntity> tileEntityType = null;

   public CreativeDrumBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 92);
      FMLJavaModLoadingContext.get().getModEventBus().register(new CreativeDrumBlock.TileEntityRegisterHandler());
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new CreativeDrumBlock.CustomBlock();
      });
   ...
   public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
      ...
      protected CustomTileEntity() {
         super(CreativeDrumBlock.tileEntityType);
      ...
      public ITextComponent func_213907_g() {
         return new StringTextComponent("creative_drum");
      }
      ...
      public ITextComponent func_145748_c_() {
         return new StringTextComponent("Creative Drum");
      }
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("creative_drum");
      }
      ...
      public TileEntity createTileEntity(BlockState state, IBlockReader world) {
         return new CreativeDrumBlock.CustomTileEntity();
      }
      ...
      public void func_196243_a(BlockState state, World world, BlockPos pos, BlockState newState, boolean isMoving) {
         if (state.func_177230_c() != newState.func_177230_c()) {
            TileEntity tileentity = world.func_175625_s(pos);
            if (tileentity instanceof CreativeDrumBlock.CustomTileEntity) {
               InventoryHelper.func_180175_a(world, pos, (CreativeDrumBlock.CustomTileEntity)tileentity);
      ...
      public int func_180641_l(BlockState blockState, World world, BlockPos pos) {
         TileEntity tileentity = world.func_175625_s(pos);
         return tileentity instanceof CreativeDrumBlock.CustomTileEntity ? Container.func_94526_b((CreativeDrumBlock.CustomTileEntity)tileentity) : 0;
      }
   }
   ...
   private static class TileEntityRegisterHandler {
      ...
      public void registerTileEntity(Register<TileEntityType<?>> event) {
         event.getRegistry().register(net.minecraft.tileentity.TileEntityType.Builder.func_223042_a(CreativeDrumBlock.CustomTileEntity::new, new Block[]{CreativeDrumBlock.block}).func_206865_a((Type)null).setRegistryName("creative_drum"));
      }
