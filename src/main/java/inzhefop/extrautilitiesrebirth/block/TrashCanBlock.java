...
import inzhefop.extrautilitiesrebirth.gui.TrashCanGUIGui;
...
public class TrashCanBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:trash_can")
   public static final Block block = null;
   @ObjectHolder("extrautilitiesrebirth:trash_can")
   public static final TileEntityType<TrashCanBlock.CustomTileEntity> tileEntityType = null;

   public TrashCanBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 110);
      FMLJavaModLoadingContext.get().getModEventBus().register(new TrashCanBlock.TileEntityRegisterHandler());
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new TrashCanBlock.CustomBlock();
      });
   ...
   public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
      ...
      protected CustomTileEntity() {
         super(TrashCanBlock.tileEntityType);
      ...
      public ITextComponent func_213907_g() {
         return new StringTextComponent("trash_can");
      }
      ...
      public Container func_213906_a(int id, PlayerInventory player) {
         return new TrashCanGUIGui.GuiContainerMod(id, player, (new PacketBuffer(Unpooled.buffer())).func_179255_a(this.func_174877_v()));
      }
   ...
   public static class CustomBlock extends Block {
      ...
      public CustomBlock() {
         super(net.minecraft.block.AbstractBlock.Properties.func_200945_a(Material.field_151573_f).func_200947_a(SoundType.field_185852_e).func_200948_a(1.2F, 30.0F).func_235838_a_((s) -> {
            return 0;
         ...
         this.setRegistryName("trash_can");
      }
      ...
      public VoxelShape func_220053_a(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
         ...
         case SOUTH:
         default:
            return VoxelShapes.func_216384_a(func_208617_a(15.0D, 0.0D, 15.0D, 1.0D, 15.0D, 1.0D), new VoxelShape[0]).func_197751_a(offset.field_72450_a, offset.field_72448_b, offset.field_72449_c);
         case NORTH:
            return VoxelShapes.func_216384_a(func_208617_a(1.0D, 0.0D, 1.0D, 15.0D, 15.0D, 15.0D), new VoxelShape[0]).func_197751_a(offset.field_72450_a, offset.field_72448_b, offset.field_72449_c);
         case EAST:
            return VoxelShapes.func_216384_a(func_208617_a(15.0D, 0.0D, 1.0D, 1.0D, 15.0D, 15.0D), new VoxelShape[0]).func_197751_a(offset.field_72450_a, offset.field_72448_b, offset.field_72449_c);
         case WEST:
            return VoxelShapes.func_216384_a(func_208617_a(1.0D, 0.0D, 15.0D, 15.0D, 15.0D, 1.0D), new VoxelShape[0]).func_197751_a(offset.field_72450_a, offset.field_72448_b, offset.field_72449_c);
         }
      }
      ...
      public void func_225534_a_(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
         ...
         int y = pos.func_177956_o();
         int z = pos.func_177952_p();
         TrashCanUpdateTickProcedure.executeProcedure((Map)Stream.of(new SimpleEntry("world", world), new SimpleEntry("x", x), new SimpleEntry("y", y), new SimpleEntry("z", z)).collect(HashMap::new, (_m, _e) -> {
         ...
         if (entity instanceof ServerPlayerEntity) {
            NetworkHooks.openGui((ServerPlayerEntity)entity, new INamedContainerProvider() {
               ...
               public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
                  return new TrashCanGUIGui.GuiContainerMod(id, inventory, (new PacketBuffer(Unpooled.buffer())).func_179255_a(new BlockPos(x, y, z)));
               }
            }, new BlockPos(x, y, z));
         }
      ...
      public TileEntity createTileEntity(BlockState state, IBlockReader world) {
         return new TrashCanBlock.CustomTileEntity();
      }
      ...
      public void func_196243_a(BlockState state, World world, BlockPos pos, BlockState newState, boolean isMoving) {
         if (state.func_177230_c() != newState.func_177230_c()) {
            TileEntity tileentity = world.func_175625_s(pos);
            if (tileentity instanceof TrashCanBlock.CustomTileEntity) {
               InventoryHelper.func_180175_a(world, pos, (TrashCanBlock.CustomTileEntity)tileentity);
      ...
      public int func_180641_l(BlockState blockState, World world, BlockPos pos) {
         TileEntity tileentity = world.func_175625_s(pos);
         return tileentity instanceof TrashCanBlock.CustomTileEntity ? Container.func_94526_b((TrashCanBlock.CustomTileEntity)tileentity) : 0;
      }
   ...
   private static class TileEntityRegisterHandler {
      ...
      public void registerTileEntity(Register<TileEntityType<?>> event) {
         event.getRegistry().register(net.minecraft.tileentity.TileEntityType.Builder.func_223042_a(TrashCanBlock.CustomTileEntity::new, new Block[]{TrashCanBlock.block}).func_206865_a((Type)null).setRegistryName("trash_can"));
      }
