...
public class GlowstoneGlassBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:glowstone_glass")
   public static final Block block = null;

   public GlowstoneGlassBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 59);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new GlowstoneGlassBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("glowstone_glass");
      }
