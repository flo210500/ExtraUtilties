...
public class WoodSpikeBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:wood_spike")
   public static final Block block = null;

   public WoodSpikeBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 47);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new WoodSpikeBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         super(net.minecraft.block.AbstractBlock.Properties.func_200945_a(Material.field_151575_d).func_200947_a(SoundType.field_185848_a).func_200948_a(6.0F, 15.0F).func_235838_a_((s) -> {
            return 0;
         }).harvestLevel(1).harvestTool(ToolType.AXE).func_226896_b_().func_235828_a_((bs, br, bp) -> {
            return false;
         }));
         this.setRegistryName("wood_spike");
      }
