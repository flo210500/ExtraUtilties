...
public class SextupleCompressedCobblestoneBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:sextuple_compressed_cobblestone")
   public static final Block block = null;

   public SextupleCompressedCobblestoneBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 23);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new SextupleCompressedCobblestoneBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("sextuple_compressed_cobblestone");
      }
      ...
      public void func_190948_a(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
         ...
         list.add(new StringTextComponent("§7531441 Blocks"));
      }
