...
public class QuartzburntBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:quartzburnt")
   public static final Block block = null;

   public QuartzburntBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 13);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new QuartzburntBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         super(net.minecraft.block.AbstractBlock.Properties.func_200945_a(Material.field_151576_e).func_200947_a(SoundType.field_185851_d).func_200948_a(8.0F, 15.0F).func_235838_a_((s) -> {
            return 0;
         }).harvestLevel(1).harvestTool(ToolType.PICKAXE));
         this.setRegistryName("quartzburnt");
      }
      ...
      public void func_190948_a(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
         ...
         list.add(new StringTextComponent("§7Resonator: Quartz [8000 FE]"));
      }
