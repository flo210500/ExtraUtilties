...
public class EnderQuarryUpgradeBaseBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:ender_quarry_upgrade_base")
   public static final Block block = null;

   public EnderQuarryUpgradeBaseBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 104);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new EnderQuarryUpgradeBaseBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("ender_quarry_upgrade_base");
      }
