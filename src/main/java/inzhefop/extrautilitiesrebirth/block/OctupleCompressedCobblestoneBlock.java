...
public class OctupleCompressedCobblestoneBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:octuple_compressed_cobblestone")
   public static final Block block = null;

   public OctupleCompressedCobblestoneBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 25);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new OctupleCompressedCobblestoneBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("octuple_compressed_cobblestone");
      }
      ...
      public void func_190948_a(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
         ...
         list.add(new StringTextComponent("§743046721 Blocks"));
      }
