...
public class MagicalWoodBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:magical_wood")
   public static final Block block = null;

   public MagicalWoodBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 85);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new MagicalWoodBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("magical_wood");
      }
      ...
      public void func_190948_a(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
         ...
         list.add(new StringTextComponent("§7Enchanter: Book Shelf + Lapis Lazuli [64000 FE]"));
      }
