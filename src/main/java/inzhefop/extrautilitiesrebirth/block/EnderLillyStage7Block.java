...
public class EnderLillyStage7Block extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:ender_lilly_stage_7")
   public static final Block block = null;

   public EnderLillyStage7Block(ExtrautilitiesrebirthModElements instance) {
      super(instance, 167);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new EnderLillyStage7Block.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("ender_lilly_stage_7");
      }
