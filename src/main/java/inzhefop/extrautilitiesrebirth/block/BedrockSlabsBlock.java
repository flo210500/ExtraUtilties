...
public class BedrockSlabsBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:bedrock_slabs")
   public static final Block block = null;

   public BedrockSlabsBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 5);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new BedrockSlabsBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      ...
      public CustomBlock() {
         ...
         this.setRegistryName("bedrock_slabs");
      }
