...
import inzhefop.extrautilitiesrebirth.gui.GoldenChestGUIGui;
...
public class GoldChestBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:gold_chest")
   public static final Block block = null;
   @ObjectHolder("extrautilitiesrebirth:gold_chest")
   public static final TileEntityType<GoldChestBlock.CustomTileEntity> tileEntityType = null;

   public GoldChestBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 34);
      FMLJavaModLoadingContext.get().getModEventBus().register(new GoldChestBlock.TileEntityRegisterHandler());
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new GoldChestBlock.CustomBlock();
      });
   ...
   public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
      ...
      protected CustomTileEntity() {
         super(GoldChestBlock.tileEntityType);
         this.stacks = NonNullList.func_191197_a(54, ItemStack.field_190927_a);
      ...
      public ITextComponent func_213907_g() {
         return new StringTextComponent("gold_chest");
      }
      ...
      public Container func_213906_a(int id, PlayerInventory player) {
         return new GoldenChestGUIGui.GuiContainerMod(id, player, (new PacketBuffer(Unpooled.buffer())).func_179255_a(this.func_174877_v()));
      }
   ...
   public static class CustomBlock extends Block {
      ...
      public CustomBlock() {
         super(net.minecraft.block.AbstractBlock.Properties.func_200945_a(Material.field_151573_f).func_200947_a(SoundType.field_185852_e).func_200948_a(2.5F, 80.0F).func_235838_a_((s) -> {
            return 0;
         ...
         this.setRegistryName("gold_chest");
      }
         ...
         if (entity instanceof ServerPlayerEntity) {
            NetworkHooks.openGui((ServerPlayerEntity)entity, new INamedContainerProvider() {
               ...
               public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
                  return new GoldenChestGUIGui.GuiContainerMod(id, inventory, (new PacketBuffer(Unpooled.buffer())).func_179255_a(new BlockPos(x, y, z)));
               }
            }, new BlockPos(x, y, z));
         }
      ...
      public TileEntity createTileEntity(BlockState state, IBlockReader world) {
         return new GoldChestBlock.CustomTileEntity();
      }
      ...
      public void func_196243_a(BlockState state, World world, BlockPos pos, BlockState newState, boolean isMoving) {
         if (state.func_177230_c() != newState.func_177230_c()) {
            TileEntity tileentity = world.func_175625_s(pos);
            if (tileentity instanceof GoldChestBlock.CustomTileEntity) {
               InventoryHelper.func_180175_a(world, pos, (GoldChestBlock.CustomTileEntity)tileentity);
      ...
      public int func_180641_l(BlockState blockState, World world, BlockPos pos) {
         TileEntity tileentity = world.func_175625_s(pos);
         return tileentity instanceof GoldChestBlock.CustomTileEntity ? Container.func_94526_b((GoldChestBlock.CustomTileEntity)tileentity) : 0;
      }
   ...
   private static class TileEntityRegisterHandler {
      ...
      public void registerTileEntity(Register<TileEntityType<?>> event) {
         event.getRegistry().register(net.minecraft.tileentity.TileEntityType.Builder.func_223042_a(GoldChestBlock.CustomTileEntity::new, new Block[]{GoldChestBlock.block}).func_206865_a((Type)null).setRegistryName("gold_chest"));
      }
