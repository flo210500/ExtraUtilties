...
public class EdgedStoneBricksBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:edged_stone_bricks")
   public static final Block block = null;

   public EdgedStoneBricksBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 11);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new EdgedStoneBricksBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("edged_stone_bricks");
      }
