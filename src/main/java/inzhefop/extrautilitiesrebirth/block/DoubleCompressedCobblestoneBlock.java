...
public class DoubleCompressedCobblestoneBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:double_compressed_cobblestone")
   public static final Block block = null;

   public DoubleCompressedCobblestoneBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 19);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new DoubleCompressedCobblestoneBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("double_compressed_cobblestone");
      }
