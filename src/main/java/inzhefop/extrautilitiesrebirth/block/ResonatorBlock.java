...
import inzhefop.extrautilitiesrebirth.gui.ResonantorGUIGui;
...
public class ResonatorBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:resonator")
   public static final Block block = null;
   @ObjectHolder("extrautilitiesrebirth:resonator")
   public static final TileEntityType<ResonatorBlock.CustomTileEntity> tileEntityType = null;

   public ResonatorBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 102);
      FMLJavaModLoadingContext.get().getModEventBus().register(new ResonatorBlock.TileEntityRegisterHandler());
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new ResonatorBlock.CustomBlock();
      });
   ...
   public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
      ...
      protected CustomTileEntity() {
         super(ResonatorBlock.tileEntityType);
      ...
      public ITextComponent func_213907_g() {
         return new StringTextComponent("resonator");
      }
      ...
      public Container func_213906_a(int id, PlayerInventory player) {
         return new ResonantorGUIGui.GuiContainerMod(id, player, (new PacketBuffer(Unpooled.buffer())).func_179255_a(this.func_174877_v()));
      }
   ...
   public static class CustomBlock extends Block {
      ...
      public CustomBlock() {
         ...
         this.setRegistryName("resonator");
      }
      ...
      public VoxelShape func_220053_a(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
         ...
         case SOUTH:
         default:
            return VoxelShapes.func_216384_a(func_208617_a(16.0D, 0.0D, 16.0D, 0.0D, 15.0D, 0.0D), new VoxelShape[0]).func_197751_a(offset.field_72450_a, offset.field_72448_b, offset.field_72449_c);
         case NORTH:
            return VoxelShapes.func_216384_a(func_208617_a(0.0D, 0.0D, 0.0D, 16.0D, 15.0D, 16.0D), new VoxelShape[0]).func_197751_a(offset.field_72450_a, offset.field_72448_b, offset.field_72449_c);
         case EAST:
            return VoxelShapes.func_216384_a(func_208617_a(16.0D, 0.0D, 0.0D, 0.0D, 15.0D, 16.0D), new VoxelShape[0]).func_197751_a(offset.field_72450_a, offset.field_72448_b, offset.field_72449_c);
         case WEST:
            return VoxelShapes.func_216384_a(func_208617_a(0.0D, 0.0D, 16.0D, 16.0D, 15.0D, 0.0D), new VoxelShape[0]).func_197751_a(offset.field_72450_a, offset.field_72448_b, offset.field_72449_c);
         }
      }
      ...
      public void func_225534_a_(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
         ...
         int y = pos.func_177956_o();
         int z = pos.func_177952_p();
         ResonatorUpdateTickProcedure.executeProcedure((Map)Stream.of(new SimpleEntry("world", world), new SimpleEntry("x", x), new SimpleEntry("y", y), new SimpleEntry("z", z)).collect(HashMap::new, (_m, _e) -> {
         ...
         if (entity instanceof ServerPlayerEntity) {
            NetworkHooks.openGui((ServerPlayerEntity)entity, new INamedContainerProvider() {
               ...
               public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
                  return new ResonantorGUIGui.GuiContainerMod(id, inventory, (new PacketBuffer(Unpooled.buffer())).func_179255_a(new BlockPos(x, y, z)));
               }
            }, new BlockPos(x, y, z));
         }
      ...
      public TileEntity createTileEntity(BlockState state, IBlockReader world) {
         return new ResonatorBlock.CustomTileEntity();
      }
      ...
      public void func_196243_a(BlockState state, World world, BlockPos pos, BlockState newState, boolean isMoving) {
         if (state.func_177230_c() != newState.func_177230_c()) {
            TileEntity tileentity = world.func_175625_s(pos);
            if (tileentity instanceof ResonatorBlock.CustomTileEntity) {
               InventoryHelper.func_180175_a(world, pos, (ResonatorBlock.CustomTileEntity)tileentity);
      ...
      public int func_180641_l(BlockState blockState, World world, BlockPos pos) {
         TileEntity tileentity = world.func_175625_s(pos);
         return tileentity instanceof ResonatorBlock.CustomTileEntity ? Container.func_94526_b((ResonatorBlock.CustomTileEntity)tileentity) : 0;
      }
   ...
   private static class TileEntityRegisterHandler {
      ...
      public void registerTileEntity(Register<TileEntityType<?>> event) {
         event.getRegistry().register(net.minecraft.tileentity.TileEntityType.Builder.func_223042_a(ResonatorBlock.CustomTileEntity::new, new Block[]{ResonatorBlock.block}).func_206865_a((Type)null).setRegistryName("resonator"));
      }
