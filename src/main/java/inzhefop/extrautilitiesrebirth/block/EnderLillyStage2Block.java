...
public class EnderLillyStage2Block extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:ender_lilly_stage_2")
   public static final Block block = null;

   public EnderLillyStage2Block(ExtrautilitiesrebirthModElements instance) {
      super(instance, 162);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new EnderLillyStage2Block.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("ender_lilly_stage_2");
      }
