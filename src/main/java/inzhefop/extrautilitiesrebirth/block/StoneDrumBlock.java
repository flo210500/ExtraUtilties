...
public class StoneDrumBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:stone_drum")
   public static final Block block = null;
   @ObjectHolder("extrautilitiesrebirth:stone_drum")
   public static final TileEntityType<StoneDrumBlock.CustomTileEntity> tileEntityType = null;

   public StoneDrumBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 96);
      FMLJavaModLoadingContext.get().getModEventBus().register(new StoneDrumBlock.TileEntityRegisterHandler());
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new StoneDrumBlock.CustomBlock();
      });
   ...
   public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
      ...
      protected CustomTileEntity() {
         super(StoneDrumBlock.tileEntityType);
      ...
      public ITextComponent func_213907_g() {
         return new StringTextComponent("stone_drum");
      }
      ...
      public ITextComponent func_145748_c_() {
         return new StringTextComponent("Stone Drum");
      }
   ...
   public static class CustomBlock extends Block {
      ...
      public CustomBlock() {
         ...
         this.setRegistryName("stone_drum");
      }
      ...
      public TileEntity createTileEntity(BlockState state, IBlockReader world) {
         return new StoneDrumBlock.CustomTileEntity();
      }
      ...
      public void func_196243_a(BlockState state, World world, BlockPos pos, BlockState newState, boolean isMoving) {
         if (state.func_177230_c() != newState.func_177230_c()) {
            TileEntity tileentity = world.func_175625_s(pos);
            if (tileentity instanceof StoneDrumBlock.CustomTileEntity) {
               InventoryHelper.func_180175_a(world, pos, (StoneDrumBlock.CustomTileEntity)tileentity);
      ...
      public int func_180641_l(BlockState blockState, World world, BlockPos pos) {
         TileEntity tileentity = world.func_175625_s(pos);
         return tileentity instanceof StoneDrumBlock.CustomTileEntity ? Container.func_94526_b((StoneDrumBlock.CustomTileEntity)tileentity) : 0;
      }
   ...
   private static class TileEntityRegisterHandler {
      ...
      public void registerTileEntity(Register<TileEntityType<?>> event) {
         event.getRegistry().register(net.minecraft.tileentity.TileEntityType.Builder.func_223042_a(StoneDrumBlock.CustomTileEntity::new, new Block[]{StoneDrumBlock.block}).func_206865_a((Type)null).setRegistryName("stone_drum"));
      }
