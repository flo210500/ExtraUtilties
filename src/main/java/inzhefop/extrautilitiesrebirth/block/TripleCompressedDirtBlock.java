...
public class TripleCompressedDirtBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:triple_compressed_dirt")
   public static final Block block = null;

   public TripleCompressedDirtBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 28);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new TripleCompressedDirtBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("triple_compressed_dirt");
      }
