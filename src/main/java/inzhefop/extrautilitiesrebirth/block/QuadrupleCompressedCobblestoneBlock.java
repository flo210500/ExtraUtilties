...
public class QuadrupleCompressedCobblestoneBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:quadruple_compressed_cobblestone")
   public static final Block block = null;

   public QuadrupleCompressedCobblestoneBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 21);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new QuadrupleCompressedCobblestoneBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("quadruple_compressed_cobblestone");
      }
      ...
      public void func_190948_a(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
         ...
         list.add(new StringTextComponent("§76561 Blocks"));
      }
