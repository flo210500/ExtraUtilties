...
public class EnderLillyStage4Block extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:ender_lilly_stage_4")
   public static final Block block = null;

   public EnderLillyStage4Block(ExtrautilitiesrebirthModElements instance) {
      super(instance, 164);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new EnderLillyStage4Block.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("ender_lilly_stage_4");
      }
