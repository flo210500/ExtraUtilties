...
public class BedrockCobblestoneBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:bedrock_cobblestone")
   public static final Block block = null;

   public BedrockCobblestoneBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 4);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new BedrockCobblestoneBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      ...
      public CustomBlock() {
         super(net.minecraft.block.AbstractBlock.Properties.func_200945_a(Material.field_151576_e).func_200947_a(SoundType.field_185851_d).func_200948_a(800.0F, 1.8E7F).func_235838_a_((s) -> {
            return 0;
         ...
         this.setRegistryName("bedrock_cobblestone");
      }
