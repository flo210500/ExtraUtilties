...
public class SurvivalGeneratorBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:survival_generator")
   public static final Block block = null;
   @ObjectHolder("extrautilitiesrebirth:survival_generator")
   public static final TileEntityType<SurvivalGeneratorBlock.CustomTileEntity> tileEntityType = null;

   public SurvivalGeneratorBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 81);
      FMLJavaModLoadingContext.get().getModEventBus().register(new SurvivalGeneratorBlock.TileEntityRegisterHandler());
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new SurvivalGeneratorBlock.CustomBlock();
      });
   ...
   public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
      ...
      protected CustomTileEntity() {
         super(SurvivalGeneratorBlock.tileEntityType);
      ...
      public ITextComponent func_213907_g() {
         return new StringTextComponent("survival_generator");
      }
      ...
      public ITextComponent func_145748_c_() {
         return new StringTextComponent("Survival Generator");
      }
   ...
   public static class CustomBlock extends Block {
      ...
      public CustomBlock() {
         ...
         this.setRegistryName("survival_generator");
      }
      ...
      public TileEntity createTileEntity(BlockState state, IBlockReader world) {
         return new SurvivalGeneratorBlock.CustomTileEntity();
      }
      ...
      public void func_196243_a(BlockState state, World world, BlockPos pos, BlockState newState, boolean isMoving) {
         if (state.func_177230_c() != newState.func_177230_c()) {
            TileEntity tileentity = world.func_175625_s(pos);
            if (tileentity instanceof SurvivalGeneratorBlock.CustomTileEntity) {
               InventoryHelper.func_180175_a(world, pos, (SurvivalGeneratorBlock.CustomTileEntity)tileentity);
      ...
      public int func_180641_l(BlockState blockState, World world, BlockPos pos) {
         TileEntity tileentity = world.func_175625_s(pos);
         return tileentity instanceof SurvivalGeneratorBlock.CustomTileEntity ? Container.func_94526_b((SurvivalGeneratorBlock.CustomTileEntity)tileentity) : 0;
      }
   ...
   private static class TileEntityRegisterHandler {
      ...
      public void registerTileEntity(Register<TileEntityType<?>> event) {
         event.getRegistry().register(net.minecraft.tileentity.TileEntityType.Builder.func_223042_a(SurvivalGeneratorBlock.CustomTileEntity::new, new Block[]{SurvivalGeneratorBlock.block}).func_206865_a((Type)null).setRegistryName("survival_generator"));
      }
