...
public class IneffableGlassBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:ineffable_glass")
   public static final Block block = null;

   public IneffableGlassBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 62);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new IneffableGlassBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("ineffable_glass");
      }
