...
public class SeptupleCompressedCobblestoneBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:septuple_compressed_cobblestone")
   public static final Block block = null;

   public SeptupleCompressedCobblestoneBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 24);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new SeptupleCompressedCobblestoneBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("septuple_compressed_cobblestone");
      }
      ...
      public void func_190948_a(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
         ...
         list.add(new StringTextComponent("§74782969 Blocks"));
      }
