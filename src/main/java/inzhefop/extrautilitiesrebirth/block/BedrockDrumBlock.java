...
public class BedrockDrumBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:bedrock_drum")
   public static final Block block = null;
   @ObjectHolder("extrautilitiesrebirth:bedrock_drum")
   public static final TileEntityType<BedrockDrumBlock.CustomTileEntity> tileEntityType = null;

   public BedrockDrumBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 93);
      FMLJavaModLoadingContext.get().getModEventBus().register(new BedrockDrumBlock.TileEntityRegisterHandler());
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new BedrockDrumBlock.CustomBlock();
      });
   ...
   public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
      ...
      protected CustomTileEntity() {
         super(BedrockDrumBlock.tileEntityType);
         ...
         this.fluidTank = new FluidTank(65536000) {
      ...
      public ITextComponent func_213907_g() {
         return new StringTextComponent("bedrock_drum");
      }
      ...
      public ITextComponent func_145748_c_() {
         return new StringTextComponent("Bedrock Drum");
      }
   ...
   public static class CustomBlock extends Block {
      ...
      public CustomBlock() {
         super(net.minecraft.block.AbstractBlock.Properties.func_200945_a(Material.field_151576_e).func_200947_a(SoundType.field_185851_d).func_200948_a(20.0F, 8000.0F).func_235838_a_((s) -> {
            return 0;
         ...
         this.setRegistryName("bedrock_drum");
      }
      ...
      public VoxelShape func_220053_a(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
         ...
         case SOUTH:
         default:
            return VoxelShapes.func_216384_a(func_208617_a(14.0D, 0.0D, 14.0D, 2.0D, 1.0D, 2.0D), new VoxelShape[]{func_208617_a(12.0D, 1.0D, 12.0D, 6.0D, 15.0D, 6.0D), func_208617_a(14.0D, 16.0D, 14.0D, 2.0D, 1.0D, 2.0D)}).func_197751_a(offset.field_72450_a, offset.field_72448_b, offset.field_72449_c);
         case NORTH:
         ...
         case EAST:
            return VoxelShapes.func_216384_a(func_208617_a(14.0D, 0.0D, 2.0D, 2.0D, 1.0D, 14.0D), new VoxelShape[]{func_208617_a(12.0D, 1.0D, 4.0D, 6.0D, 15.0D, 10.0D), func_208617_a(14.0D, 16.0D, 2.0D, 2.0D, 1.0D, 14.0D)}).func_197751_a(offset.field_72450_a, offset.field_72448_b, offset.field_72449_c);
         case WEST:
            return VoxelShapes.func_216384_a(func_208617_a(2.0D, 0.0D, 14.0D, 14.0D, 1.0D, 2.0D), new VoxelShape[]{func_208617_a(4.0D, 1.0D, 12.0D, 10.0D, 15.0D, 6.0D), func_208617_a(2.0D, 16.0D, 14.0D, 14.0D, 1.0D, 2.0D)}).func_197751_a(offset.field_72450_a, offset.field_72448_b, offset.field_72449_c);
         }
      }
      ...
      public TileEntity createTileEntity(BlockState state, IBlockReader world) {
         return new BedrockDrumBlock.CustomTileEntity();
      }
      ...
      public void func_196243_a(BlockState state, World world, BlockPos pos, BlockState newState, boolean isMoving) {
         if (state.func_177230_c() != newState.func_177230_c()) {
            TileEntity tileentity = world.func_175625_s(pos);
            if (tileentity instanceof BedrockDrumBlock.CustomTileEntity) {
               InventoryHelper.func_180175_a(world, pos, (BedrockDrumBlock.CustomTileEntity)tileentity);
      ...
      public int func_180641_l(BlockState blockState, World world, BlockPos pos) {
         TileEntity tileentity = world.func_175625_s(pos);
         return tileentity instanceof BedrockDrumBlock.CustomTileEntity ? Container.func_94526_b((BedrockDrumBlock.CustomTileEntity)tileentity) : 0;
      }
   ...
   private static class TileEntityRegisterHandler {
      ...
      public void registerTileEntity(Register<TileEntityType<?>> event) {
         event.getRegistry().register(net.minecraft.tileentity.TileEntityType.Builder.func_223042_a(BedrockDrumBlock.CustomTileEntity::new, new Block[]{BedrockDrumBlock.block}).func_206865_a((Type)null).setRegistryName("bedrock_drum"));
      }
