...
public class QuadrupleCompressedDirtBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:quadruple_compressed_dirt")
   public static final Block block = null;

   public QuadrupleCompressedDirtBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 29);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new QuadrupleCompressedDirtBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("quadruple_compressed_dirt");
      }
