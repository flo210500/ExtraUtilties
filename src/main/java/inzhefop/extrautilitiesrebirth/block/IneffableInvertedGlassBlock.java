...
public class IneffableInvertedGlassBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:ineffable_inverted_glass")
   public static final Block block = null;

   public IneffableInvertedGlassBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 63);
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new IneffableInvertedGlassBlock.CustomBlock();
      });
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         ...
         this.setRegistryName("ineffable_inverted_glass");
      }
