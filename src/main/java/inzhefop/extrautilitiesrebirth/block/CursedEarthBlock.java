...
public class CursedEarthBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:cursed_earth")
   public static final Block block = null;
   @ObjectHolder("extrautilitiesrebirth:cursed_earth")
   public static final TileEntityType<CursedEarthBlock.CustomTileEntity> tileEntityType = null;

   public CursedEarthBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 38);
      FMLJavaModLoadingContext.get().getModEventBus().register(new CursedEarthBlock.TileEntityRegisterHandler());
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new CursedEarthBlock.CustomBlock();
      });
   ...
   public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
      ...
      protected CustomTileEntity() {
         super(CursedEarthBlock.tileEntityType);
      ...
      public ITextComponent func_213907_g() {
         return new StringTextComponent("cursed_earth");
      }
      ...
      public ITextComponent func_145748_c_() {
         return new StringTextComponent("Cursed Earth");
      }
   ...
   public static class CustomBlock extends Block {
      public CustomBlock() {
         super(net.minecraft.block.AbstractBlock.Properties.func_200945_a(Material.field_151578_c).func_200947_a(SoundType.field_185849_b).func_200948_a(3.0F, 20.0F).func_235838_a_((s) -> {
            return 0;
         }).harvestLevel(1).harvestTool(ToolType.SHOVEL));
         this.setRegistryName("cursed_earth");
      }
      ...
      public void func_190948_a(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
         ...
         list.add(new StringTextComponent("§7Apply a drop of evil to a grass-block"));
      }
      ...
      public void func_220082_b(BlockState blockstate, World world, BlockPos pos, BlockState oldState, boolean moving) {
         ...
         world.func_205220_G_().func_205360_a(pos, this, 1200);
      }
      ...
      public void func_225534_a_(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
         ...
         int y = pos.func_177956_o();
         int z = pos.func_177952_p();
         CursedEarthUpdateTickProcedure.executeProcedure((Map)Stream.of(new SimpleEntry("world", world), new SimpleEntry("x", x), new SimpleEntry("y", y), new SimpleEntry("z", z)).collect(HashMap::new, (_m, _e) -> {
      ...
      public TileEntity createTileEntity(BlockState state, IBlockReader world) {
         return new CursedEarthBlock.CustomTileEntity();
      }
      ...
      public void func_196243_a(BlockState state, World world, BlockPos pos, BlockState newState, boolean isMoving) {
         if (state.func_177230_c() != newState.func_177230_c()) {
            TileEntity tileentity = world.func_175625_s(pos);
            if (tileentity instanceof CursedEarthBlock.CustomTileEntity) {
               InventoryHelper.func_180175_a(world, pos, (CursedEarthBlock.CustomTileEntity)tileentity);
      ...
      public int func_180641_l(BlockState blockState, World world, BlockPos pos) {
         TileEntity tileentity = world.func_175625_s(pos);
         return tileentity instanceof CursedEarthBlock.CustomTileEntity ? Container.func_94526_b((CursedEarthBlock.CustomTileEntity)tileentity) : 0;
      }
   }
   ...
   private static class TileEntityRegisterHandler {
      ...
      public void registerTileEntity(Register<TileEntityType<?>> event) {
         event.getRegistry().register(net.minecraft.tileentity.TileEntityType.Builder.func_223042_a(CursedEarthBlock.CustomTileEntity::new, new Block[]{CursedEarthBlock.block}).func_206865_a((Type)null).setRegistryName("cursed_earth"));
      }
