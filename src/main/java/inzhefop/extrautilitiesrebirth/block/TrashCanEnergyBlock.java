...
public class TrashCanEnergyBlock extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:trash_can_energy")
   public static final Block block = null;
   @ObjectHolder("extrautilitiesrebirth:trash_can_energy")
   public static final TileEntityType<TrashCanEnergyBlock.CustomTileEntity> tileEntityType = null;

   public TrashCanEnergyBlock(ExtrautilitiesrebirthModElements instance) {
      super(instance, 111);
      FMLJavaModLoadingContext.get().getModEventBus().register(new TrashCanEnergyBlock.TileEntityRegisterHandler());
   }

   public void initElements() {
      this.elements.blocks.add(() -> {
         return new TrashCanEnergyBlock.CustomBlock();
      });
   ...
   public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
      ...
      protected CustomTileEntity() {
         super(TrashCanEnergyBlock.tileEntityType);
         ...
         this.energyStorage = new EnergyStorage(Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 0) {
      ...
      public ITextComponent func_213907_g() {
         return new StringTextComponent("trash_can_energy");
      }
      ...
      public ITextComponent func_145748_c_() {
         return new StringTextComponent("Trash Can [Energy]");
      }
   ...
   public static class CustomBlock extends Block {
      ...
      public CustomBlock() {
         ...
         this.setRegistryName("trash_can_energy");
      }
      ...
      public void func_225534_a_(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
         ...
         int y = pos.func_177956_o();
         int z = pos.func_177952_p();
         TrashCanEnergyUpdateTickProcedure.executeProcedure((Map)Stream.of(new SimpleEntry("world", world), new SimpleEntry("x", x), new SimpleEntry("y", y), new SimpleEntry("z", z)).collect(HashMap::new, (_m, _e) -> {
      ...
      public TileEntity createTileEntity(BlockState state, IBlockReader world) {
         return new TrashCanEnergyBlock.CustomTileEntity();
      }
      ...
      public void func_196243_a(BlockState state, World world, BlockPos pos, BlockState newState, boolean isMoving) {
         if (state.func_177230_c() != newState.func_177230_c()) {
            TileEntity tileentity = world.func_175625_s(pos);
            if (tileentity instanceof TrashCanEnergyBlock.CustomTileEntity) {
               InventoryHelper.func_180175_a(world, pos, (TrashCanEnergyBlock.CustomTileEntity)tileentity);
      ...
      public int func_180641_l(BlockState blockState, World world, BlockPos pos) {
         TileEntity tileentity = world.func_175625_s(pos);
         return tileentity instanceof TrashCanEnergyBlock.CustomTileEntity ? Container.func_94526_b((TrashCanEnergyBlock.CustomTileEntity)tileentity) : 0;
      }
   ...
   private static class TileEntityRegisterHandler {
      ...
      public void registerTileEntity(Register<TileEntityType<?>> event) {
         event.getRegistry().register(net.minecraft.tileentity.TileEntityType.Builder.func_223042_a(TrashCanEnergyBlock.CustomTileEntity::new, new Block[]{TrashCanEnergyBlock.block}).func_206865_a((Type)null).setRegistryName("trash_can_energy"));
      }
