...
public class RedCoalItem extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:red_coal")
   public static final Item block = null;

   public RedCoalItem(ExtrautilitiesrebirthModElements instance) {
      super(instance, 135);
   }

   public void initElements() {
      this.elements.items.add(() -> {
         return new RedCoalItem.ItemCustom();
      });
   }
   ...
   public static class ItemCustom extends Item {
      ...
      public void func_77624_a(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
         ...
         list.add(new StringTextComponent("§7Resonator: Coal [16000 FE]"));
      }
   }
}
