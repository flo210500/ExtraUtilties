...
public class UnstableNuggetItem extends ExtrautilitiesrebirthModElements.ModElement {
   @ObjectHolder("extrautilitiesrebirth:unstable_nugget")
   public static final Item block = null;

   public UnstableNuggetItem(ExtrautilitiesrebirthModElements instance) {
      super(instance, 139);
   }

   public void initElements() {
      this.elements.items.add(() -> {
         return new UnstableNuggetItem.ItemCustom();
      });
   }
   ...
   public static class ItemCustom extends Item {
      public ItemCustom() {
         ...
         this.setRegistryName("unstable_nugget");
      }
      ...
      public void func_77624_a(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
         ...
         list.add(new StringTextComponent("§7Stable"));
      }
   }
}
