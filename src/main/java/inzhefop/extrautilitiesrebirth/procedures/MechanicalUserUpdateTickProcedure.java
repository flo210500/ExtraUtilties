   ...
   public static void executeProcedure(Map<String, Object> dependencies) {
      if (dependencies.get("world") == null) {
         if (!dependencies.containsKey("world")) {
            ExtrautilitiesrebirthMod.LOGGER.warn("Failed to load dependency world for procedure MechanicalUserUpdateTick!");
         }

      } else if (dependencies.get("x") == null) {
         if (!dependencies.containsKey("x")) {
            ExtrautilitiesrebirthMod.LOGGER.warn("Failed to load dependency x for procedure MechanicalUserUpdateTick!");
         }

      } else if (dependencies.get("y") == null) {
         if (!dependencies.containsKey("y")) {
            ExtrautilitiesrebirthMod.LOGGER.warn("Failed to load dependency y for procedure MechanicalUserUpdateTick!");
         }

      } else if (dependencies.get("z") == null) {
         if (!dependencies.containsKey("z")) {
            ExtrautilitiesrebirthMod.LOGGER.warn("Failed to load dependency z for procedure MechanicalUserUpdateTick!");
         }
         ...
         if (((<undefinedtype>)(new Object() {
         ...
         })).getItemStack(new BlockPos(x, y, z), 8).func_77973_b() == SpeedUpgradeItem.block) {
            ...
            })).getAmount(world, new BlockPos(x, y, z), 8) * 0.4D;
         }
         ...
         if (((<undefinedtype>)(new Object() {
         ...
         })).getItemStack(new BlockPos(x, y, z), 8).func_77973_b() == EnchantedSpeedUpgradeItem.block) {
            multiplier = (double)((<undefinedtype>)(new Object() {
               public int getAmount(IWorld world, BlockPos pos, int sltid) {
                  AtomicInteger _retval = new AtomicInteger(0);
                  TileEntity _ent = world.func_175625_s(pos);
            ...
            })).getAmount(world, new BlockPos(x, y, z), 8) * 0.5D;
         }
         ...
         if (((<undefinedtype>)(new Object() {
         ...
         })).getItemStack(new BlockPos(x, y, z), 8).func_77973_b() == SuperSpeedUpgradeItem.block) {
            multiplier = (double)((<undefinedtype>)(new Object() {
               public int getAmount(IWorld world, BlockPos pos, int sltid) {
                  AtomicInteger _retval = new AtomicInteger(0);
                  TileEntity _ent = world.func_175625_s(pos);
            ...
            })).getAmount(world, new BlockPos(x, y, z), 8) * 0.6D;
         }
         ...
         for(index3 = 0; index3 < 8; ++index3) {
            ...
            })).getItemStack(new BlockPos(x, y, z), (int)slotnumber).func_77973_b() && Blocks.field_150350_a != ((<undefinedtype>)(new Object() {
               public BlockState toBlock(ItemStack _stk) {
                  return _stk.func_77973_b() instanceof BlockItem ? ((BlockItem)_stk.func_77973_b()).func_179223_d().func_176223_P() : Blocks.field_150350_a.func_176223_P();
               }
            })).toBlock(((<undefinedtype>)(new Object() {
               public ItemStack getItemStack(BlockPos pos, int sltid) {
                  AtomicReference<ItemStack> _retval = new AtomicReference(ItemStack.field_190927_a);
                  TileEntity _ent = world.func_175625_s(pos);
                  if (_ent != null) {
            ...
            })).getItemStack(new BlockPos(x, y, z), (int)slotnumber)).func_177230_c()) {
               valid = true;
               break;
            }
         ...
         TileEntity _tileEntity;
         BlockState _bs;
         if (Blocks.field_150350_a == targetblock.func_177230_c() && valid && ((<undefinedtype>)(new Object() {
            public double getValue(IWorld world, BlockPos pos, String tag) {
               TileEntity tileEntity = world.func_175625_s(pos);
               return tileEntity != null ? tileEntity.getTileData().func_74769_h(tag) : -1.0D;
            }
         })).getValue(world, new BlockPos(x, y, z), "machinemode") == 1.0D) {
            if ((double)((<undefinedtype>)(new Object() {
               ...
               _amount = (int)Math.pow(4.0D * multiplier, 2.0D);
               if (_ent != null) {
                  _ent.getCapability(CapabilityEnergy.ENERGY, (Direction)null).ifPresent((capability) -> {
            ...
            if (((<undefinedtype>)(new Object() {
               ...
               for(index3 = 0; index3 < 8; ++index3) {
                  if (Blocks.field_150350_a.func_199767_j() != ((<undefinedtype>)(new Object() {
                     ...
                     world.func_180501_a(new BlockPos(target_x, target_y, target_z), ((<undefinedtype>)(new Object() {
                        public BlockState toBlock(ItemStack _stk) {
                           return _stk.func_77973_b() instanceof BlockItem ? ((BlockItem)_stk.func_77973_b()).func_179223_d().func_176223_P() : Blocks.field_150350_a.func_176223_P();
                        }
                     })).toBlock(((<undefinedtype>)(new Object() {
                     ...
                     })).getItemStack(new BlockPos(x, y, z), (int)slotnumber)), 3);
                     _tileEntity = world.func_175625_s(new BlockPos(x, y, z));
                     if (_tileEntity != null) {
                        _sltid = (int)slotnumber;
                        _amount = true;
                        _tileEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, (Direction)null).ifPresent((capability) -> {
                           if (capability instanceof IItemHandlerModifiable) {
                              ItemStack _stk = capability.getStackInSlot(_sltid).func_77946_l();
         ...
         for(index3 = 0; index3 < 8; ++index3) {
            ...
            })).getItemStack(new BlockPos(x, y, z), (int)slotnumber).func_77973_b()) {
               valid = true;
               break;
            }
            ...
            if (((<undefinedtype>)(new Object() {
               ...
               for(index3 = 0; index3 < 8; ++index3) {
                  if (Blocks.field_150350_a.func_199767_j() != ((<undefinedtype>)(new Object() {
                     ...
                     dropitem = ((<undefinedtype>)(new Object() {
                        public ItemStack getItemStack(BlockPos pos, int sltid) {
                           AtomicReference<ItemStack> _retval = new AtomicReference(ItemStack.field_190927_a);
                           TileEntity _ent = world.func_175625_s(pos);
                           if (_ent != null) {
                     ...
                     })).getItemStack(new BlockPos(x, y, z), (int)slotnumber);
                     dropitem.func_190920_e(1);
                     if (world instanceof World && !world.func_201670_d()) {
                        ItemEntity entityToSpawn = new ItemEntity((World)world, target_x, target_y, target_z, dropitem);
         ...
         for(index3 = 0; index3 < 8; ++index3) {
            ...
            })).getItemStack(new BlockPos(x, y, z), (int)repit).func_77973_b() instanceof SwordItem) {
               swordinserted = true;
               break;
            }
         ...
         if (((<undefinedtype>)(new Object() {
         ...
         })).getValue(world, new BlockPos(x, y, z), "machinemode") == 0.0D && swordinserted) {
            if ((double)((<undefinedtype>)(new Object() {
               public int getEnergyStored(IWorld world, BlockPos pos) {
                  AtomicInteger _retval = new AtomicInteger(0);
                  TileEntity _ent = world.func_175625_s(pos);
            ...
            if (((<undefinedtype>)(new Object() {
               ...
               slotnumber = 0.0D;
               List<Entity> _entfound = (List)world.func_175647_a(Entity.class, new AxisAlignedBB(target_x - 2.5D, target_y - 2.5D, target_z - 2.5D, target_x + 2.5D, target_y + 2.5D, target_z + 2.5D), (Predicate)null).stream().sorted(((<undefinedtype>)(new Object() {
               ...
               while(var43.hasNext()) {
                  Entity entityiterator = (Entity)var43.next();
                  if ((entityiterator instanceof PlayerEntity ? ((PlayerEntity)entityiterator).func_71024_bL().func_75116_a() : 0) <= 0 && Blocks.field_150350_a.func_199767_j() == ((<undefinedtype>)(new Object() {
                     ...
                     if (_ent != null) {
                        int _sltid = (int)repit;
                        int _amount = true;
                        _ent.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, (Direction)null).ifPresent((capability) -> {
                           if (capability instanceof IItemHandlerModifiable) {
                              ItemStack _stk = capability.getStackInSlot(_sltid).func_77946_l();
                              if (_stk.func_96631_a(1, new Random(), (ServerPlayerEntity)null)) {
                                 _stk.func_190918_g(1);
                                 _stk.func_196085_b(0);
                              }
                     ...
                     entityiterator.func_70097_a(DamageSource.field_76377_j, 4.0F);
                  }
               }
